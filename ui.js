...
class fe extends pe{}fe.directiveName="unsafeSVG",fe.resultType=2;const be=de(fe),me="important",ge=" !"+me,ve=de(class extends he{constructor(e){var t;if(super(e),e.type!==le||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,i)=>{const a=e[i];return null==a?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`}),"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ht){this.ht=new Set;for(const e in t)this.ht.add(e);return this.render(t)}this.ht.forEach((e=>{null==t[e]&&(this.ht.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")}));for(const e in t){const a=t[e];if(null!=a){this.ht.add(e);const t="string"==typeof a&&a.endsWith(ge);e.includes("-")||t?i.setProperty(e,t?a.slice(0,-11):a,t?me:""):i[e]=a}}return F}});var we=__webpack_require__(4536),xe=__webpack_require__(7948),ke=__webpack_require__.n(xe);const ye="./w/api",$e=s(we.A);function Se(e){return[$e,e]}const _e=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches,ze="1.8.17";function Ce(e){" "==e.key&&(e.preventDefault(),e.target.click())}class Ie extends oe{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return o`
    ...
    `}render(){if(!this.svg)return M``;const e={};return this.size?(e.width=this.size,e.height=this.size):(this.width&&(e.width=this.width),this.height&&(e.height=this.height)),M`<svg style="${ve(e)}">
      <g>${be(this.svg)}</g>
    </svg>`}}customElements.define("fa-icon",Ie),customElements.define("wr-anim-logo",class extends Ie{constructor(){super(),this.svg=ke()}static get styles(){return o`
      #wrlogo #stop5687 {
    ...
    `}}),customElements.define("wr-modal",class extends oe{constructor(){super(),this.title="",this.bgClass="",this.noBgClose=!1}static get properties(){return{title:{type:String},bgClass:{type:String},noBgClose:{type:Boolean}}}static get styles(){return Se(o`
      .modal-background {
    ...
    `)}render(){return M` <div class="modal is-active">
      <div
    ...
    </div>`}onClose(){this.dispatchEvent(new CustomEvent("modal-closed"))}});var Ae,Ue=__webpack_require__(8340),Pe=__webpack_require__.n(Ue),De=__webpack_require__(6532),Le=__webpack_require__.n(De),Te=__webpack_require__(4939),Ee=__webpack_require__.n(Te);function Re(e,t){void 0===t&&(t={});var i=t.registrationOptions;void 0===i&&(i={}),delete t.registrationOptions;var a=function(e){for(var i=[],a=arguments.length-1;a-- >0;)i[a]=arguments[a+1];t&&t[e]&&t[e].apply(t,i)};"serviceWorker"in navigator&&Ae.then((function(){Boolean("localhost"===window.location.hostname||"[::1]"===window.location.hostname||window.location.hostname.match(/^127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}$/))?(!function(e,t,i){fetch(e).then((function(a){404===a.status?(t("error",new Error("Service worker not found at "+e)),qe()):-1===a.headers.get("content-type").indexOf("javascript")?(t("error",new Error("Expected "+e+" to have javascript content-type, but received "+a.headers.get("content-type"))),qe()):Ne(e,t,i)})).catch((function(e){return Oe(t,e)}))}(e,a,i),navigator.serviceWorker.ready.then((function(e){a("ready",e)})).catch((function(e){return Oe(a,e)}))):(Ne(e,a,i),navigator.serviceWorker.ready.then((function(e){a("ready",e)})).catch((function(e){return Oe(a,e)})))}))}function Oe(e,t){navigator.onLine||e("offline"),e("error",t)}function Ne(e,t,i){navigator.serviceWorker.register(e,i).then((function(e){t("registered",e),e.waiting?t("updated",e):e.onupdatefound=function(){t("updatefound",e);var i=e.installing;i.onstatechange=function(){"installed"===i.state&&(navigator.serviceWorker.controller?t("updated",e):t("cached",e))}}})).catch((function(e){return Oe(t,e)}))}function qe(){"serviceWorker"in navigator&&navigator.serviceWorker.ready.then((function(e){e.unregister()})).catch((function(e){return Oe(emit,e)}))}"undefined"!=typeof window&&(Ae="undefined"!=typeof Promise?new Promise((function(e){return window.addEventListener("load",e)})):{then:function(e){return window.addEventListener("load",e)}});class Me{constructor({name:e="sw.js",scope:t="./",appName:i="ReplayWeb.page",requireSubdomainIframe:a=!1}={}){this.name=e,this.scope=t,this.appName=i,this.requireSubdomainIframe=a,this.errorMsg=null}setAppName(e){this.appName=e}register(){let e,t;const i=new Promise(((i,a)=>{e=i,t=a}));this.errorMsg=this.getSWErrorMsg(),this.errorMsg&&(console.error(this.errorMsg),t(this.errorMsg));const a=e=>{console.error("Error during service worker registration:",e),this.errorMsg=this.getCrossOriginIframeMsg(),this.errorMsg||(this.errorMsg=`${this.appName} could not be loaded due to the following error:\n${e.toString()}`),t(this.errorMsg)};return Re(this.scope+this.name,{registrationOptions:{scope:this.scope},registered(){console.log("Service worker is registered"),e()},error(e){a(e)}}),i}getCrossOriginIframeMsg(){return this.isCrossOriginIframe()?`      Sorry, Service Workers can not be used in cross-origin iframes.\n      This web archive embed is loaded from ${window.location.origin} but the top page is on a different origin.\n      The embed must be loaded from the same origin or a subdomain.`:null}isCrossOriginIframe(){if(window.parent===window)return!1;try{return""===window.top.location.href}catch(e){return!0}}getSWErrorMsg(){if(navigator.serviceWorker)return this.requireSubdomainIframe&&!this.isCrossOriginIframe()?`Sorry, due to security settings, this ${this.appName} embed only be viewed within a subdomain iframe.`:null;const e=this.getCrossOriginIframeMsg();return e||(window.isSecureContext?"MozAppearance"in document.documentElement.style?"Sorry, Service Workers are disabled in Firefox in Private Mode. Please try loading this page in regular mode instead.":`Sorry, ${this.appName} won't work in this browser as Service Workers are not supported in this window.\n  Please try a different browser.`:`\n      Sorry, the ${this.appName} system must be loaded from an HTTPS URL (or localhost), but was loaded from: ${window.location.host}.\n      Please try loading this page from an HTTPS URL`)}renderErrorReport(e,t){const i=this.errorMsg||t;return i?M`
    ...
    `}get mainLogo(){return ke()}renderNavBrand(){return M` <span
      id="home"
      ...
      <nav class="navbar has-background-info" aria-label="main">
              ...
              `:M`
                ...
                ${this.collTitle?M`
                      ...
                      <span class="no-wrap is-size-6"
                        >&nbsp;&nbsp;/&nbsp;
                        ${this.pageReplay?M`<i>${this.pageTitle}</i>`:this.pageTitle}
                      </span>
                    `:""}
              `}
          <a
        ...
        ${this.sourceUrl?M``:M` <div
            ...
            >
              ...
              ${this.embed?M``:M` <div class="navbar-end">${this.renderNavEnd()}</div>`}
            </div>`}
      </nav>
      <p id="skip-main-target" tabindex="-1" class="is-sr-only">Skipped</p>`}renderNavEnd(){return M` <a href="/docs" target="_blank" class="navbar-item is-size-6">
        <fa-icon .svg="${Pe()}" aria-hidden="true"></fa-icon
        ><span>&nbsp;User Docs</span>
      </a>
      <!--
    ...
    ></wr-coll>`}renderHomeIndex(){return M` <wr-coll-index>
      ${_e?"":M`
      ...
      ></wr-chooser>
    </wr-coll-index>`}render(){return this.inited?this.embed&&this.swErrorMsg?this.swErrorMsg:M`
                ...
                <div class="content">
                  <div style="display: flex">
                    <div class="has-text-centered" style="width: 220px">
                      ...
                      <div style="font-size: smaller; margin-bottom: 1em">${_e?"App":""} v${ze}</div>
                    </div>
    ...
    `}renderHeader(){return M`<h2 class="panel-heading panel-color">
      <span>${this.headerName}</span>
    </h2>`}renderSearchHeader(){return""}render(){const e=this.childElementCount>0;return M`
      ...
      <section class="section no-top-padding">
        ...
        <button @click=${()=>this.hideHeader=!this.hideHeader} class="collapse button is-small">
          <span class="icon"><fa-icon .svg=${this.hideHeader?Ye():Ze()}></span>
        ...
        <div class="panel">
          ...
          ${this.colls.length?M`
                ...
                <div class="coll-list">
                  ${this.sortedColls&&this.sortedColls.map(((e,t)=>M`
                      <div class="coll-block panel-block">
                        ${this.renderCollInfo(e)}
                        ${this._deleting[e.sourceUrl]?M` <span
              ...
              `:M`
                <div class="panel-block extra-padding">
                  ${null===this.sortedColls?M`<i>Loading Archives...</i>`:this.renderEmpty()}
                </div>
              `}
        </div>
      </section>
    `}renderCollInfo(e){return M`<wr-coll-info .coll=${e}></wr-coll-info>`}renderEmpty(){return M`<i
      >No Archives so far! Archives loaded in the section above will appear
      here.</i
    >`}}class tt extends oe{constructor(){super(),this.detailed=!1,this.canDelete=!1}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},canDelete:{type:Boolean}}}static get styles(){return Se(tt.compStyles)}static get compStyles(){return o`
      .columns {
        width: 100%;
      }
      .column {
    ...
    `}renderSource(e){return M`
      <div class="column is-4">
        <span class="source-text"
          ><p class="minihead">Source</p>
          ${e.sourceUrl&&(e.sourceUrl.startsWith("http://")||e.sourceUrl.startsWith("https://"))?M` <a href="${e.sourceUrl}">${e.sourceUrl}&nbsp;</a>`:M` ${e.sourceUrl}&nbsp;`}
        </span>

        <a @click="${t=>this.onCopy(t,e.sourceUrl)}" class="copy">
          <fa-icon .svg="${Ve()}"></fa-icon>
        </a>
        ${e.sourceUrl&&e.sourceUrl.startsWith("googledrive://")?M` <p><i>(${e.filename})</i></p>`:""}
      </div>
      ...
      <div class="column is-2">
        ...
        ${We()(Number(e.totalSize||e.size||0))}
      </div>
    `}renderSummaryView(){const e=this.coll;return M` <div class="columns">
      ...
      ${this.renderSource(e)}
    </div>`}renderDetailed(){const e=this.coll;let{numValid:t,numInvalid:i,domain:a,certFingerprint:r,datapackageHash:s,publicKey:o,software:n}=this.coll.verify||{};t=t||0,i=i||0;const l=r?`https://crt.sh/?q=${r}`:"";return M` <div class="columns">
      <div class="column col-title is-4">
        <span class="subtitle has-text-weight-bold">
          ${e.name||e.title||e.filename}
        </span>
      </div>
      ${e.desc?M` <div class="column">
            <p class="minihead">Description</p>
            ${e.desc}
          </div>`:M``}
      ${e.description?M`<div class="column">
            <p class="minihead">Description</p>
            ${e.description}
          </div>`:M``}
      <!--  Only show filename if coll.resources doesn't exist -->
      ${e.resources?M`<div class="column">
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
function*(e,t){if(void 0!==e){let i=0;for(const a of e)yield t(a,i++)}}(e.resources,(e=>M`<li>
                    <a href="${e.path}">${e.name+"\n"}</a>
                  </li>`))}
            </ol>
          </div>`:M`<div class="column">
    ...
    </div>`}render(){return this.detailed?this.renderDetailed():this.renderSummaryView()}onCopy(e,t){return e.preventDefault(),e.stopPropagation(),navigator.clipboard.writeText(t),!1}onPurge(e){const t={reload:e};this.dispatchEvent(new CustomEvent("coll-purge",{detail:t}))}}function it(e){if(!e)return"";e.length<14&&(e+="00000101000000".substr(e.length));const t=e.substring(0,4)+"-"+e.substring(4,6)+"-"+e.substring(6,8)+"T"+e.substring(8,10)+":"+e.substring(10,12)+":"+e.substring(12,14)+"-00:00";return new Date(t)}function at(e){let t=null;try{t=new Date(e.ts||e.date)}catch(e){}const i=t&&!isNaN(t)?rt(t.toISOString()):"";return{date:t,timestamp:i}}function rt(e){return e.replace(/[-:T]/g,"").slice(0,14)}function st(e,t,i){const a=new URLSearchParams;return a.set("view",e),a.set("url",t),a.set("ts",i),"#"+a.toString()}async function ot(e){try{new URL(e)}catch(t){e=new URL(e,document.baseURI).href}const t=await async function(e,t){const i=(new TextEncoder).encode(e),a=await crypto.subtle.digest(t,i),r=Array.from(new Uint8Array(a)).map((e=>e.toString(16).padStart(2,"0"))).join("");return r}(e,"SHA-256");return{url:e,coll:"id-"+t.slice(0,12)}}customElements.define("wr-coll-info",tt),customElements.define("wr-coll-index",et);var nt=__webpack_require__(4e3),lt=__webpack_require__.n(nt),ct=__webpack_require__(2427),dt=__webpack_require__.n(ct),ht=__webpack_require__(4562),pt=__webpack_require__.n(ht),ut=__webpack_require__(494),ft=__webpack_require__.n(ut),bt=__webpack_require__(886),mt=__webpack_require__.n(bt),gt=__webpack_require__(1940),vt=__webpack_require__.n(gt),wt=__webpack_require__(2724),xt=__webpack_require__.n(wt),kt=__webpack_require__(9397),yt=__webpack_require__.n(kt),$t=__webpack_require__(5017),St=__webpack_require__.n($t),_t=__webpack_require__(96),zt=__webpack_require__.n(_t),Ct=__webpack_require__(5139),It=__webpack_require__.n(Ct),At=__webpack_require__(3898),Ut=__webpack_require__.n(At),Pt=__webpack_require__(8657),Dt=__webpack_require__.n(Pt),Lt=__webpack_require__(6736),Tt=__webpack_require__.n(Lt),Et=__webpack_require__(1453),Rt=__webpack_require__.n(Et),Ot=__webpack_require__(3954),Nt=__webpack_require__.n(Ot),qt=__webpack_require__(2785),Mt=__webpack_require__.n(qt);class Ft extends oe{constructor(){super(),this.collInfo=null,this.appLogo=null,this.ts=null,this.url=null,this.active=!1}get renderRoot(){return this}static get properties(){return{collInfo:{type:Object},appLogo:{type:Object},url:{type:String},ts:{type:String},active:{type:Boolean}}}static get embedStyles(){return o`
      rwp-embed-receipt {
        display: flex;
        flex-direction: column;
      }
    ...
    `}render(){let{numValid:e,numInvalid:t,domain:i,certFingerprint:a,datapackageHash:r,publicKey:s,software:o}=this.collInfo.verify||{};e=e||0,t=t||0;const n=this.collInfo.sourceUrl,l=a?`https://crt.sh/?q=${a}`:"",c=it(this.ts).toLocaleString();return M`
          ...
          <div class="dropdown-content embed-info-drop">
            ...
            <div class="embed-info-drop-statscontainer mb-4">
              ...
              ${i?M`
                  ...
                  `:o?M` <h3 class="mt-2">Created With:</h3>
                    <p>${o}</p>`:""}
              ${!i&&s?M` <h3 class="mt-2">Observer Public Key:</h3>
                    <p class="show-key">${s}</p>`:""}
              <h3 class="mt-2">Validation:</h3>
              ${e>0||t>0?M` <p>
                    ${e} hashes
                    verified${t?M`, ${t} invalid`:""}
                  </p>`:M` <p>Not Available</p> `}
              <h3 class="mt-2">Package Hash:</h3>
              <p class="show-hash">${r}</p>
              <h3 class="mt-2">Size</h3>
              <p>${We()(Number(this.collInfo.size||0))}</p>
            </div>
            ${n?M``:""}
            <p
    ...
    `}onEmbedDrop(e){e.stopPropagation(),this.active=!this.active}}customElements.define("rwp-embed-receipt",Ft);var Bt="undefined"!=typeof window?window:null,jt=null===Bt,Ht=jt?void 0:Bt.document,Wt="addEventListener",Gt="removeEventListener",Vt="getBoundingClientRect",Kt="_a",Zt="_b",Jt="_c",Yt="horizontal",Qt=function(){return!1},Xt=jt?"calc":["","-webkit-","-moz-","-o-"].filter((function(e){var t=Ht.createElement("div");return t.style.cssText="width:"+e+"calc(9px)",!!t.style.length})).shift()+"calc",ei=function(e){return"string"==typeof e||e instanceof String},ti=function(e){if(ei(e)){var t=Ht.querySelector(e);if(!t)throw new Error("Selector "+e+" did not match a DOM element");return t}return e},ii=function(e,t,i){var a=e[t];return void 0!==a?a:i},ai=function(e,t,i,a){if(t){if("end"===a)return 0;if("center"===a)return e/2}else if(i){if("start"===a)return 0;if("center"===a)return e/2}return e},ri=function(e,t){var i=Ht.createElement("div");return i.className="gutter gutter-"+t,i},si=function(e,t,i){var a={};return ei(t)?a[e]=t:a[e]=Xt+"("+t+"% - "+i+"px)",a},oi=function(e,t){var i;return(i={})[e]=t+"px",i};const ni=function(e,t){if(void 0===t&&(t={}),jt)return{};var i,a,r,s,o,n,l=e;Array.from&&(l=Array.from(l));var c=ti(l[0]).parentNode,d=getComputedStyle?getComputedStyle(c):null,h=d?d.flexDirection:null,p=ii(t,"sizes")||l.map((function(){return 100/l.length})),u=ii(t,"minSize",100),f=Array.isArray(u)?u:l.map((function(){return u})),b=ii(t,"maxSize",1/0),m=Array.isArray(b)?b:l.map((function(){return b})),g=ii(t,"expandToMin",!1),v=ii(t,"gutterSize",10),w=ii(t,"gutterAlign","center"),x=ii(t,"snapOffset",30),k=Array.isArray(x)?x:l.map((function(){return x})),y=ii(t,"dragInterval",1),$=ii(t,"direction",Yt),S=ii(t,"cursor",$===Yt?"col-resize":"row-resize"),_=ii(t,"gutter",ri),z=ii(t,"elementStyle",si),C=ii(t,"gutterStyle",oi);function I(e,t,a,r){var s=z(i,t,a,r);Object.keys(s).forEach((function(t){e.style[t]=s[t]}))}function A(){return n.map((function(e){return e.size}))}function U(e){return"touches"in e?e.touches[0][a]:e[a]}function P(e){var t=n[this.a],i=n[this.b],a=t.size+i.size;t.size=e/this.size*a,i.size=a-e/this.size*a,I(t.element,t.size,this[Zt],t.i),I(i.element,i.size,this[Jt],i.i)}function D(e){var i,a=n[this.a],r=n[this.b];this.dragging&&(i=U(e)-this.start+(this[Zt]-this.dragOffset),y>1&&(i=Math.round(i/y)*y),i<=a.minSize+a.snapOffset+this[Zt]?i=a.minSize+this[Zt]:i>=this.size-(r.minSize+r.snapOffset+this[Jt])&&(i=this.size-(r.minSize+this[Jt])),i>=a.maxSize-a.snapOffset+this[Zt]?i=a.maxSize+this[Zt]:i<=this.size-(r.maxSize-r.snapOffset+this[Jt])&&(i=this.size-(r.maxSize+this[Jt])),P.call(this,i),ii(t,"onDrag",Qt)(A()))}function L(){var e=n[this.a].element,t=n[this.b].element,a=e[Vt](),o=t[Vt]();this.size=a[i]+o[i]+this[Zt]+this[Jt],this.start=a[r],this.end=a[s]}function T(e){var t=function(e){if(!getComputedStyle)return null;var t=getComputedStyle(e);if(!t)return null;var i=e[o];return 0===i?null:i-=$===Yt?parseFloat(t.paddingLeft)+parseFloat(t.paddingRight):parseFloat(t.paddingTop)+parseFloat(t.paddingBottom)}(c);if(null===t)return e;if(f.reduce((function(e,t){return e+t}),0)>t)return e;var i=0,a=[],r=e.map((function(r,s){var o=t*r/100,n=ai(v,0===s,s===e.length-1,w),l=f[s]+n;return o<l?(i+=l-o,a.push(0),l):(a.push(o-l),o)}));return 0===i?e:r.map((function(e,r){var s=e;if(i>0&&a[r]-i>0){var o=Math.min(i,a[r]-i);i-=o,s=e-o}return s/t*100}))}function E(){var e=this,i=n[e.a].element,a=n[e.b].element;e.dragging&&ii(t,"onDragEnd",Qt)(A()),e.dragging=!1,Bt[Gt]("mouseup",e.stop),Bt[Gt]("touchend",e.stop),Bt[Gt]("touchcancel",e.stop),Bt[Gt]("mousemove",e.move),Bt[Gt]("touchmove",e.move),e.stop=null,e.move=null,i[Gt]("selectstart",Qt),i[Gt]("dragstart",Qt),a[Gt]("selectstart",Qt),a[Gt]("dragstart",Qt),i.style.userSelect="",i.style.webkitUserSelect="",i.style.MozUserSelect="",i.style.pointerEvents="",a.style.userSelect="",a.style.webkitUserSelect="",a.style.MozUserSelect="",a.style.pointerEvents="",e.gutter.style.cursor="",e.parent.style.cursor="",Ht.body.style.cursor=""}function R(e){if(!("button"in e)||0===e.button){var i=this,a=n[i.a].element,r=n[i.b].element;i.dragging||ii(t,"onDragStart",Qt)(A()),e.preventDefault(),i.dragging=!0,i.move=D.bind(i),i.stop=E.bind(i),Bt[Wt]("mouseup",i.stop),Bt[Wt]("touchend",i.stop),Bt[Wt]("touchcancel",i.stop),Bt[Wt]("mousemove",i.move),Bt[Wt]("touchmove",i.move),a[Wt]("selectstart",Qt),a[Wt]("dragstart",Qt),r[Wt]("selectstart",Qt),r[Wt]("dragstart",Qt),a.style.userSelect="none",a.style.webkitUserSelect="none",a.style.MozUserSelect="none",a.style.pointerEvents="none",r.style.userSelect="none",r.style.webkitUserSelect="none",r.style.MozUserSelect="none",r.style.pointerEvents="none",i.gutter.style.cursor=S,i.parent.style.cursor=S,Ht.body.style.cursor=S,L.call(i),i.dragOffset=U(e)-i.end}}$===Yt?(i="width",a="clientX",r="left",s="right",o="clientWidth"):"vertical"===$&&(i="height",a="clientY",r="top",s="bottom",o="clientHeight"),p=T(p);var O=[];function N(e){var t=e.i===O.length,i=t?O[e.i-1]:O[e.i];L.call(i);var a=t?i.size-e.minSize-i[Jt]:e.minSize+i[Zt];P.call(i,a)}return n=l.map((function(e,t){var a,r={element:ti(e),size:p[t],minSize:f[t],maxSize:m[t],snapOffset:k[t],i:t};if(t>0&&((a={a:t-1,b:t,dragging:!1,direction:$,parent:c})[Zt]=ai(v,t-1==0,!1,w),a[Jt]=ai(v,!1,t===l.length-1,w),"row-reverse"===h||"column-reverse"===h)){var s=a.a;a.a=a.b,a.b=s}if(t>0){var o=_(t,$,r.element);!function(e,t,a){var r=C(i,t,a);Object.keys(r).forEach((function(t){e.style[t]=r[t]}))}(o,v,t),a[Kt]=R.bind(a),o[Wt]("mousedown",a[Kt]),o[Wt]("touchstart",a[Kt]),c.insertBefore(o,r.element),a.gutter=o}return I(r.element,r.size,ai(v,0===t,t===l.length-1,w),t),t>0&&O.push(a),r})),n.forEach((function(e){var t=e.element[Vt]()[i];t<e.minSize&&(g?N(e):e.minSize=t)})),{setSizes:function(e){var t=T(e);t.forEach((function(e,i){if(i>0){var a=O[i-1],r=n[a.a],s=n[a.b];r.size=t[i-1],s.size=e,I(r.element,r.size,a[Zt],r.i),I(s.element,s.size,a[Jt],s.i)}}))},getSizes:A,collapse:function(e){N(n[e])},destroy:function(e,t){O.forEach((function(a){if(!0!==t?a.parent.removeChild(a.gutter):(a.gutter[Gt]("mousedown",a[Kt]),a.gutter[Gt]("touchstart",a[Kt])),!0!==e){var r=z(i,a.a.size,a[Zt]);Object.keys(r).forEach((function(e){n[a.a].element.style[e]="",n[a.b].element.style[e]=""}))}}))},parent:c,pairs:O}},li="search://";class ci extends oe{constructor(){super(),this.sourceUrl=null,this.inited=!1,this.isLoading=!1,this.coll="",this.collInfo=null,this._replaceLoc=!1,this._locUpdateNeeded=!1,this._locationHash="",this.tabData={},this.url="",this.ts="",this.tabNames=["pages","story","resources","info"],this.tabLabels={pages:"Pages",story:"Story",resources:"URLs",info:"Archive Info"},this.menuActive=!1,this.embedDropdownActive=!1,this.hasStory=!1,this.editable=!1,this.browsable=!0,this.clearable=!0,this.showSidebar="1"===localStorage.getItem("pages:showSidebar"),this.splitter=null,this.isVisible=!0,this.favIconUrl="",this.autoUpdateInterval=10,this._autoUpdater=null,this.appName="ReplayWeb.page",this.appVersion=ze,this.appLogo=ke()}static get properties(){return{inited:{type:Boolean},sourceUrl:{type:String},loadInfo:{type:Object,attribute:!1},showSidebar:{type:Boolean},collInfo:{type:Object,attribute:!1},coll:{type:String},hasStory:{type:Boolean},isLoading:{type:Boolean},tabData:{type:Object,attribute:!1},url:{type:String},ts:{type:String},isFullscreen:{type:Boolean},menuActive:{type:Boolean},embed:{type:String},embedDropdownActive:{type:Boolean},editable:{type:Boolean},browsable:{type:Boolean},clearable:{type:Boolean},isVisible:{type:Boolean},favIconUrl:{type:String},appName:{type:String},appVersion:{type:String},appLogo:{type:String},autoUpdateInterval:{type:Number},swName:{type:String}}}firstUpdated(){this.inited=!0,window.addEventListener("hashchange",(e=>this.onHashChange(e))),this.addEventListener("fullscreenchange",(()=>{this.isFullscreen=!!document.fullscreenElement})),this.embed&&this.loadInfo&&this.loadInfo.hideOffscreen&&(this.observer=new IntersectionObserver((e=>{this.isVisible=e[0].isIntersecting})),this.observer.observe(this))}async runUpdateLoop(){try{for(;this.editable&&this.autoUpdateInterval&&(!this.collInfo||!this.collInfo.pages||this.collInfo.pages.length<100);)await new Promise((e=>setTimeout(e,1e3*this.autoUpdateInterval))),await this.doUpdateInfo(!0)}finally{this._autoUpdater=null}}updated(e){if(e.has("sourceUrl")&&this.doUpdateInfo(),e.has("editable")&&this.editable&&this.autoUpdateInterval&&!this._autoUpdater&&(this._autoUpdater=this.runUpdateLoop()),e.has("tabData")){if(!this.collInfo||!this.collInfo.coll)return;Object.keys(this.tabData).forEach((e=>!this.tabData[e]&&delete this.tabData[e]));const t="#"+new URLSearchParams(this.tabData).toString();if(this.tabData.url||(this.url=li+decodeURIComponent(this._paramsToString(this.tabData))),t!==this._locationHash){if(this._locationHash=t,this._replaceLoc||0===Object.keys(e.get("tabData")).length){const e=new URL(window.location.href);e.hash=this._locationHash,window.history.replaceState({},"",e.href),this._replaceLoc=!1}else if(window.location.hash=this._locationHash,!this.showSidebar){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.focus()}this.embed&&window.parent!==window&&window.parent.postMessage(this.tabData,"*")}this._locUpdateNeeded=!1}e.has("showSidebar")&&(this.embed||localStorage.setItem("pages:showSidebar",this.showSidebar?"1":"0")),(e.has("tabData")||e.has("showSidebar"))&&this.configureSplitter()}configureSplitter(){if(this.tabData.url&&this.showSidebar){const e=this.renderRoot.querySelector("#contents"),t=this.renderRoot.querySelector("wr-coll-replay");if(e&&t&&!this.splitter){const i={sizes:[30,70],minSize:[300,300],gutterSize:4,onDragStart(){t.setDisablePointer(!0)},onDragEnd(){t.setDisablePointer(!1)}};this.splitter=ni([e,t],i)}}else if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}}async doUpdateInfo(e=!1){if(e&&this.tabData.url&&!this.showSidebar)return;let t=this.loadInfo&&this.loadInfo.customColl;if(!t){t=(await ot(this.sourceUrl)).coll}this.coll=t;const i=ye+"/c/"+t,a="./w/"+t,r=await fetch(i+"?all=1");if(200!=r.status)return void(this.collInfo={});const s=await r.json();if(this.collInfo={apiPrefix:i,replayPrefix:a,coll:t,...s},this.loadInfo&&this.loadInfo.extraConfig&&this.loadInfo.extraConfig.headers){const e=this.loadInfo.extraConfig.headers;await fetch(`${i}/updateAuth`,{method:"POST",body:JSON.stringify({headers:e})})}this.collInfo.title||(this.collInfo.title=this.collInfo.filename),"replayonly"!==this.embed&&"replay-with-info"!==this.embed||(this.showSidebar=!1),this.hasStory=this.collInfo.desc||this.collInfo.lists.length,this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{collInfo:this.collInfo,alreadyLoaded:!0}})),this.onHashChange()}onCollLoaded(e){this.doUpdateInfo(),this.loadInfo=null,e.detail.sourceUrl&&(this.sourceUrl=e.detail.sourceUrl),this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{sourceUrl:this.sourceUrl,collInfo:this.collInfo}}))}onCollUpdate(e){this.editable&&(this.collInfo={...this.collInfo,...e.detail})}onHashChange(){const e=window.location.hash;if(e&&e!==this._locationHash&&(this.tabData=Object.fromEntries(new URLSearchParams(e.slice(1)).entries()),this._locationHash=e),this.collInfo.coll&&!this.tabNames.includes(this.tabData.view)){const e=this.hasStory?"story":this.editable||this.collInfo.pages.length?"pages":"resources";this.tabData={...this.tabData,view:e}}if(this.tabData.url&&this.tabData.url.startsWith("page:")){const e=Number(this.tabData.url.slice(5));if(!isNaN(e)&&e<this.collInfo.pages.length){const t=this.collInfo.pages[e];this.tabData.url=t.url,this.tabData.ts=at(t).timestamp}}this.hasStory||"story"!==this.tabData.view||(this.tabData.view="pages"),this.tabData.url&&this.tabData.query&&(this.showSidebar=!0)}onTabClick(e){e.preventDefault();const t=e.currentTarget.getAttribute("href");return this.tabData={...this.tabData,view:t.slice(1)},!1}onCollTabNav(e){e.detail.reload?this.onRefresh(null,!0):e.target.id===this.tabData.view||"replay"===e.target.id&&this.tabData.url?this.updateTabData(e.detail.data,e.detail.replaceLoc,!1):this.showSidebar&&this.tabData.url&&this.updateTabData(e.detail.data,e.detail.replaceLoc,!0)}updateTabData(e,t=!1){this.tabData={...this.tabData,...e},this.tabData.url&&(this.url=this.tabData.url||""),this.tabData.ts&&(this.ts=this.tabData.ts||""),this._replaceLoc=!this._locUpdateNeeded&&t,this._locUpdateNeeded=!0}static get styles(){return Se(ci.compStyles)}static get compStyles(){return o`
      :host {
        display: flex;
        flex-direction: column;
        height: 100%;
      ...
      @media screen and (max-width: ${_e?o`1163px`:o`1053px`}) {
        .tab-label {
          display: none;
        }
    ...
    `}render(){if(!this.inited)return M``;const e=!!this.tabData.url,t=e&&this.showSidebar;if(!e&&this.tabData&&this.tabData.view){const e={title:this.tabLabels[this.tabData.view],replayTitle:!1};this.dispatchEvent(new CustomEvent("update-title",{bubbles:!0,composed:!0,detail:e}))}return this.collInfo&&!this.collInfo.coll?M` <wr-loader
        .loadInfo="${this.loadInfo}"
        embed="${this.embed}"
        swName="${this.swName}"
        .coll="${this.coll}"
      ...
      `:M``}renderTabHeader(e){return M` <nav
      class="main tabs is-centered ${e?"sidebar":""}"
      aria-label="tabs"
    >
      <ul>
        ${e?M` <li class="sidebar-nav left">
              <a
                role="button"
                href="#"
        ...
        ${e?M` <li class="sidebar-nav right">
              <a
                role="button"
                href="#"
    ...
    </nav>`}renderLocationBar(){if("replayonly"===this.embed||"replay-with-info"==this.embed)return"";const e=it(this.ts).toLocaleString(),t=!!this.tabData.url,i=t&&this.favIconUrl;return M` <a
        class="skip-link"
        ...
        <div class="field has-addons">
          ...
          <form @submit="${this.onSubmit}">
            ...
            >
              ...
              />
              ${t?M`<p id="datetime" class="control is-hidden-mobile">
                    ${e}
                  </p>`:M``}
              ${i?M` <span class="favicon icon is-small is-left">
          ...
          >
            ...
            <div class="dropdown-menu" id="menu-dropdown">
              <div class="dropdown-content">
                ...
                ${this.clearable?M` <hr class="dropdown-divider is-hidden-desktop" />
                      <a
                        href="#"
                        role="button"
                        class="dropdown-item"
                ...
                ${!this.editable&&this.sourceUrl.startsWith("http://")||this.sourceUrl.startsWith("https://")?M` <hr class="dropdown-divider" />
                      <a
                        href="${this.sourceUrl}"
                        role="button"
                        class="dropdown-item"
                ...
                ${e?M` <hr class="dropdown-divider is-hidden-desktop" />
      ...
      <p id="skip-replay-target" tabindex="-1" class="is-sr-only">Skipped</p>`}renderVerifyInfo(){return"replay-with-info"!==this.embed?"":M`<rwp-embed-receipt
      .collInfo=${this.collInfo}
      url=${this.url}
      ts=${this.ts}
      .appLogo=${this.appLogo}
    >
    </rwp-embed-receipt>`}dragStart(){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.setDisablePointer(!0)}dragEnd(){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.setDisablePointer(!1)}renderCollInfo(){return M` <div class="info-bg">
      <wr-coll-info
        class="is-list"
        .coll="${this.collInfo}"
        ?detailed="${!0}"
      ...
      ></wr-coll-info>
    </div>`}renderExtraToolbar(){return""}renderCollTabs(e){const t=this.hasStory&&"story"===this.tabData.view,i="pages"===this.tabData.view,a="resources"===this.tabData.view,r="info"===this.tabData.view;return M`
      ${r?this.renderCollInfo():M``}
      ${t?M` <wr-coll-story
            .collInfo="${this.collInfo}"
            .active="${t}"
    ...
    `}skipMenu(e){e.preventDefault(),this.renderRoot.querySelector("#skip-replay-target").focus()}onKeyDown(e){"Esc"!==e.key&&"Escape"!==e.key||(e.preventDefault(),e.currentTarget.value=this.url)}onMenu(e){e.stopPropagation(),this.menuActive=!this.menuActive,this.menuActive&&document.addEventListener("click",(()=>{this.menuActive=!1}),{once:!0})}onFullscreenToggle(e){e.preventDefault(),this.menuActive=!1,this.isFullscreen?document.exitFullscreen():this.requestFullscreen()}onGoBack(e){e.preventDefault(),this.menuActive=!1,window.history.back()}onGoForward(e){e.preventDefault(),this.menuActive=!1,window.history.forward()}onShowPages(e){e.preventDefault(),this.showSidebar||document.documentElement.clientWidth>=769?this.showSidebar=!this.showSidebar:(this.showSidebar=!1,this.updateTabData({url:"",ts:""}))}onFullPageView(e){e.preventDefault(),this.updateTabData({url:"",ts:""})}onHideSidebar(e){e.preventDefault(),this.showSidebar=!1}async onFavIcons(e){for(const t of e.detail.icons){const e=await fetch(t.href);if(200===e.status){const i=e.headers.get("Content-Type");if(i&&!i.startsWith("text/"))return void(this.favIconUrl=t.href)}}this.favIconUrl=""}onPurgeCache(e){e.preventDefault();const t=!e.detail||void 0===e.detail.reload||e.detail.reload;this.deleteFully(t)}async deleteFully(e=!1){const t=this.collInfo.apiPrefix+(e?"?reload=1":""),i=await fetch(t,{method:"DELETE"});200!==i.status&&console.warn("purge failed: "+i.status),e||this.embed?window.location.reload():window.location.search=""}onSubmit(e){e.preventDefault();const t=this.renderRoot.querySelector("input");return t.value?this.navigateTo(t.value):t.value=this.url,!1}onLostFocus(e){e.currentTarget.value||(e.currentTarget.value=this.url)}navigateTo(e){let t;if(e.startsWith("http://")||e.startsWith("https://")){if(t={url:e},e===this.tabData.url){const e=this.renderRoot.querySelector("wr-coll-replay");return void(e&&e.refresh())}}else t=e.startsWith(li)?this._stringToParams(e):{query:e,view:"pages"};this.updateTabData(t)}_stringToParams(e){const t=new URLSearchParams(e.slice(9)),i={url:"",ts:""};for(const e of["query","view","currList","currMime","urlSearchType"])t.has(e)&&(i[e]=t.get(e));return i}_paramsToString(e){const t=new URLSearchParams;for(const i of["query","view","currList","currMime","urlSearchType"])i in e&&t.set(i,e[i]);return t.toString()}onRefresh(e,t=!1){if(e&&e.preventDefault(),this.menuActive=!1,this.tabData.url){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.refresh()}else t||window.location.reload()}onAbout(){this.dispatchEvent(new CustomEvent("about-show"))}}function di(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}customElements.define("wr-coll",ci);let hi={async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1};const pi=/[&<>"']/,ui=new RegExp(pi.source,"g"),fi=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,bi=new RegExp(fi.source,"g"),mi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},gi=e=>mi[e];function vi(e,t){if(t){if(pi.test(e))return e.replace(ui,gi)}else if(fi.test(e))return e.replace(bi,gi);return e}const wi=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function xi(e){return e.replace(wi,((e,t)=>"colon"===(t=t.toLowerCase())?":":"#"===t.charAt(0)?"x"===t.charAt(1)?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""))}const ki=/(^|[^\[])\^/g;function yi(e,t){e="string"==typeof e?e:e.source,t=t||"";const i={replace:(t,a)=>(a=(a=a.source||a).replace(ki,"$1"),e=e.replace(t,a),i),getRegex:()=>new RegExp(e,t)};return i}const $i=/[^\w:]/g,Si=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function _i(e,t,i){if(e){let e;try{e=decodeURIComponent(xi(i)).replace($i,"").toLowerCase()}catch(e){return null}if(0===e.indexOf("javascript:")||0===e.indexOf("vbscript:")||0===e.indexOf("data:"))return null}t&&!Si.test(i)&&(i=function(e,t){zi[" "+e]||(Ci.test(e)?zi[" "+e]=e+"/":zi[" "+e]=Di(e,"/",!0));e=zi[" "+e];const i=-1===e.indexOf(":");return"//"===t.substring(0,2)?i?t:e.replace(Ii,"$1")+t:"/"===t.charAt(0)?i?t:e.replace(Ai,"$1")+t:e+t}(t,i));try{i=encodeURI(i).replace(/%25/g,"%")}catch(e){return null}return i}const zi={},Ci=/^[^:]+:\/*[^/]*$/,Ii=/^([^:]+:)[\s\S]*$/,Ai=/^([^:]+:\/*[^/]*)[\s\S]*$/;const Ui={exec:function(){}};function Pi(e,t){const i=e.replace(/\|/g,((e,t,i)=>{let a=!1,r=t;for(;--r>=0&&"\\"===i[r];)a=!a;return a?"|":" |"})).split(/ \|/);let a=0;if(i[0].trim()||i.shift(),i.length>0&&!i[i.length-1].trim()&&i.pop(),i.length>t)i.splice(t);else for(;i.length<t;)i.push("");for(;a<i.length;a++)i[a]=i[a].trim().replace(/\\\|/g,"|");return i}function Di(e,t,i){const a=e.length;if(0===a)return"";let r=0;for(;r<a;){const s=e.charAt(a-r-1);if(s!==t||i){if(s===t||!i)break;r++}else r++}return e.slice(0,a-r)}function Li(e,t){if(t<1)return"";let i="";for(;t>1;)1&t&&(i+=e),t>>=1,e+=e;return i+e}function Ti(e,t,i,a){const r=t.href,s=t.title?vi(t.title):null,o=e[1].replace(/\\([\[\]])/g,"$1");if("!"!==e[0].charAt(0)){a.state.inLink=!0;const e={type:"link",raw:i,href:r,title:s,text:o,tokens:a.inlineTokens(o)};return a.state.inLink=!1,e}return{type:"image",raw:i,href:r,title:s,text:vi(o)}}class Ei{constructor(e){this.options=e||hi}space(e){const t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){const t=this.rules.block.code.exec(e);if(t){const e=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?e:Di(e,"\n")}}}fences(e){const t=this.rules.block.fences.exec(e);if(t){const e=t[0],i=function(e,t){const i=e.match(/^(\s+)(?:```)/);if(null===i)return t;const a=i[1];return t.split("\n").map((e=>{const t=e.match(/^\s+/);if(null===t)return e;const[i]=t;return i.length>=a.length?e.slice(a.length):e})).join("\n")}(e,t[3]||"");return{type:"code",raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline._escapes,"$1"):t[2],text:i}}}heading(e){const t=this.rules.block.heading.exec(e);if(t){let e=t[2].trim();if(/#$/.test(e)){const t=Di(e,"#");this.options.pedantic?e=t.trim():t&&!/ $/.test(t)||(e=t.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(e){const t=this.rules.block.hr.exec(e);if(t)return{type:"hr",raw:t[0]}}blockquote(e){const t=this.rules.block.blockquote.exec(e);if(t){const e=t[0].replace(/^ *>[ \t]?/gm,""),i=this.lexer.state.top;this.lexer.state.top=!0;const a=this.lexer.blockTokens(e);return this.lexer.state.top=i,{type:"blockquote",raw:t[0],tokens:a,text:e}}}list(e){let t=this.rules.block.list.exec(e);if(t){let i,a,r,s,o,n,l,c,d,h,p,u,f=t[1].trim();const b=f.length>1,m={type:"list",raw:"",ordered:b,start:b?+f.slice(0,-1):"",loose:!1,items:[]};f=b?`\\d{1,9}\\${f.slice(-1)}`:`\\${f}`,this.options.pedantic&&(f=b?f:"[*+-]");const g=new RegExp(`^( {0,3}${f})((?:[\t ][^\\n]*)?(?:\\n|$))`);for(;e&&(u=!1,t=g.exec(e))&&!this.rules.block.hr.test(e);){if(i=t[0],e=e.substring(i.length),c=t[2].split("\n",1)[0].replace(/^\t+/,(e=>" ".repeat(3*e.length))),d=e.split("\n",1)[0],this.options.pedantic?(s=2,p=c.trimLeft()):(s=t[2].search(/[^ ]/),s=s>4?1:s,p=c.slice(s),s+=t[1].length),n=!1,!c&&/^ *$/.test(d)&&(i+=d+"\n",e=e.substring(d.length+1),u=!0),!u){const t=new RegExp(`^ {0,${Math.min(3,s-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ \t][^\\n]*)?(?:\\n|$))`),a=new RegExp(`^ {0,${Math.min(3,s-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),r=new RegExp(`^ {0,${Math.min(3,s-1)}}(?:\`\`\`|~~~)`),o=new RegExp(`^ {0,${Math.min(3,s-1)}}#`);for(;e&&(h=e.split("\n",1)[0],d=h,this.options.pedantic&&(d=d.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ")),!r.test(d))&&!o.test(d)&&!t.test(d)&&!a.test(e);){if(d.search(/[^ ]/)>=s||!d.trim())p+="\n"+d.slice(s);else{if(n)break;if(c.search(/[^ ]/)>=4)break;if(r.test(c))break;if(o.test(c))break;if(a.test(c))break;p+="\n"+d}n||d.trim()||(n=!0),i+=h+"\n",e=e.substring(h.length+1),c=d.slice(s)}}m.loose||(l?m.loose=!0:/\n *\n *$/.test(i)&&(l=!0)),this.options.gfm&&(a=/^\[[ xX]\] /.exec(p),a&&(r="[ ] "!==a[0],p=p.replace(/^\[[ xX]\] +/,""))),m.items.push({type:"list_item",raw:i,task:!!a,checked:r,loose:!1,text:p}),m.raw+=i}m.items[m.items.length-1].raw=i.trimRight(),m.items[m.items.length-1].text=p.trimRight(),m.raw=m.raw.trimRight();const v=m.items.length;for(o=0;o<v;o++)if(this.lexer.state.top=!1,m.items[o].tokens=this.lexer.blockTokens(m.items[o].text,[]),!m.loose){const e=m.items[o].tokens.filter((e=>"space"===e.type)),t=e.length>0&&e.some((e=>/\n.*\n/.test(e.raw)));m.loose=t}if(m.loose)for(o=0;o<v;o++)m.items[o].loose=!0;return m}}html(e){const t=this.rules.block.html.exec(e);if(t){const e={type:"html",raw:t[0],pre:!this.options.sanitizer&&("pre"===t[1]||"script"===t[1]||"style"===t[1]),text:t[0]};if(this.options.sanitize){const i=this.options.sanitizer?this.options.sanitizer(t[0]):vi(t[0]);e.type="paragraph",e.text=i,e.tokens=this.lexer.inline(i)}return e}}def(e){const t=this.rules.block.def.exec(e);if(t){const e=t[1].toLowerCase().replace(/\s+/g," "),i=t[2]?t[2].replace(/^<(.*)>$/,"$1").replace(this.rules.inline._escapes,"$1"):"",a=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline._escapes,"$1"):t[3];return{type:"def",tag:e,raw:t[0],href:i,title:a}}}table(e){const t=this.rules.block.table.exec(e);if(t){const e={type:"table",header:Pi(t[1]).map((e=>({text:e}))),align:t[2].replace(/^ *|\| *$/g,"").split(/ *\| */),rows:t[3]&&t[3].trim()?t[3].replace(/\n[ \t]*$/,"").split("\n"):[]};if(e.header.length===e.align.length){e.raw=t[0];let i,a,r,s,o=e.align.length;for(i=0;i<o;i++)/^ *-+: *$/.test(e.align[i])?e.align[i]="right":/^ *:-+: *$/.test(e.align[i])?e.align[i]="center":/^ *:-+ *$/.test(e.align[i])?e.align[i]="left":e.align[i]=null;for(o=e.rows.length,i=0;i<o;i++)e.rows[i]=Pi(e.rows[i],e.header.length).map((e=>({text:e})));for(o=e.header.length,a=0;a<o;a++)e.header[a].tokens=this.lexer.inline(e.header[a].text);for(o=e.rows.length,a=0;a<o;a++)for(s=e.rows[a],r=0;r<s.length;r++)s[r].tokens=this.lexer.inline(s[r].text);return e}}}lheading(e){const t=this.rules.block.lheading.exec(e);if(t)return{type:"heading",raw:t[0],depth:"="===t[2].charAt(0)?1:2,text:t[1],tokens:this.lexer.inline(t[1])}}paragraph(e){const t=this.rules.block.paragraph.exec(e);if(t){const e="\n"===t[1].charAt(t[1].length-1)?t[1].slice(0,-1):t[1];return{type:"paragraph",raw:t[0],text:e,tokens:this.lexer.inline(e)}}}text(e){const t=this.rules.block.text.exec(e);if(t)return{type:"text",raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(e){const t=this.rules.inline.escape.exec(e);if(t)return{type:"escape",raw:t[0],text:vi(t[1])}}tag(e){const t=this.rules.inline.tag.exec(e);if(t)return!this.lexer.state.inLink&&/^<a /i.test(t[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&/^<\/a>/i.test(t[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&/^<(pre|code|kbd|script)(\s|>)/i.test(t[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&/^<\/(pre|code|kbd|script)(\s|>)/i.test(t[0])&&(this.lexer.state.inRawBlock=!1),{type:this.options.sanitize?"text":"html",raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,text:this.options.sanitize?this.options.sanitizer?this.options.sanitizer(t[0]):vi(t[0]):t[0]}}link(e){const t=this.rules.inline.link.exec(e);if(t){const e=t[2].trim();if(!this.options.pedantic&&/^</.test(e)){if(!/>$/.test(e))return;const t=Di(e.slice(0,-1),"\\");if((e.length-t.length)%2==0)return}else{const e=function(e,t){if(-1===e.indexOf(t[1]))return-1;const i=e.length;let a=0,r=0;for(;r<i;r++)if("\\"===e[r])r++;else if(e[r]===t[0])a++;else if(e[r]===t[1]&&(a--,a<0))return r;return-1}(t[2],"()");if(e>-1){const i=(0===t[0].indexOf("!")?5:4)+t[1].length+e;t[2]=t[2].substring(0,e),t[0]=t[0].substring(0,i).trim(),t[3]=""}}let i=t[2],a="";if(this.options.pedantic){const e=/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(i);e&&(i=e[1],a=e[3])}else a=t[3]?t[3].slice(1,-1):"";return i=i.trim(),/^</.test(i)&&(i=this.options.pedantic&&!/>$/.test(e)?i.slice(1):i.slice(1,-1)),Ti(t,{href:i?i.replace(this.rules.inline._escapes,"$1"):i,title:a?a.replace(this.rules.inline._escapes,"$1"):a},t[0],this.lexer)}}reflink(e,t){let i;if((i=this.rules.inline.reflink.exec(e))||(i=this.rules.inline.nolink.exec(e))){let e=(i[2]||i[1]).replace(/\s+/g," ");if(e=t[e.toLowerCase()],!e){const e=i[0].charAt(0);return{type:"text",raw:e,text:e}}return Ti(i,e,i[0],this.lexer)}}emStrong(e,t,i=""){let a=this.rules.inline.emStrong.lDelim.exec(e);if(!a)return;if(a[3]&&i.match(/[\p{L}\p{N}]/u))return;const r=a[1]||a[2]||"";if(!r||r&&(""===i||this.rules.inline.punctuation.exec(i))){const i=a[0].length-1;let r,s,o=i,n=0;const l="*"===a[0][0]?this.rules.inline.emStrong.rDelimAst:this.rules.inline.emStrong.rDelimUnd;for(l.lastIndex=0,t=t.slice(-1*e.length+i);null!=(a=l.exec(t));){if(r=a[1]||a[2]||a[3]||a[4]||a[5]||a[6],!r)continue;if(s=r.length,a[3]||a[4]){o+=s;continue}if((a[5]||a[6])&&i%3&&!((i+s)%3)){n+=s;continue}if(o-=s,o>0)continue;s=Math.min(s,s+o+n);const t=e.slice(0,i+a.index+(a[0].length-r.length)+s);if(Math.min(i,s)%2){const e=t.slice(1,-1);return{type:"em",raw:t,text:e,tokens:this.lexer.inlineTokens(e)}}const l=t.slice(2,-2);return{type:"strong",raw:t,text:l,tokens:this.lexer.inlineTokens(l)}}}}codespan(e){const t=this.rules.inline.code.exec(e);if(t){let e=t[2].replace(/\n/g," ");const i=/[^ ]/.test(e),a=/^ /.test(e)&&/ $/.test(e);return i&&a&&(e=e.substring(1,e.length-1)),e=vi(e,!0),{type:"codespan",raw:t[0],text:e}}}br(e){const t=this.rules.inline.br.exec(e);if(t)return{type:"br",raw:t[0]}}del(e){const t=this.rules.inline.del.exec(e);if(t)return{type:"del",raw:t[0],text:t[2],tokens:this.lexer.inlineTokens(t[2])}}autolink(e,t){const i=this.rules.inline.autolink.exec(e);if(i){let e,a;return"@"===i[2]?(e=vi(this.options.mangle?t(i[1]):i[1]),a="mailto:"+e):(e=vi(i[1]),a=e),{type:"link",raw:i[0],text:e,href:a,tokens:[{type:"text",raw:e,text:e}]}}}url(e,t){let i;if(i=this.rules.inline.url.exec(e)){let e,a;if("@"===i[2])e=vi(this.options.mangle?t(i[0]):i[0]),a="mailto:"+e;else{let t;do{t=i[0],i[0]=this.rules.inline._backpedal.exec(i[0])[0]}while(t!==i[0]);e=vi(i[0]),a="www."===i[1]?"http://"+i[0]:i[0]}return{type:"link",raw:i[0],text:e,href:a,tokens:[{type:"text",raw:e,text:e}]}}}inlineText(e,t){const i=this.rules.inline.text.exec(e);if(i){let e;return e=this.lexer.state.inRawBlock?this.options.sanitize?this.options.sanitizer?this.options.sanitizer(i[0]):vi(i[0]):i[0]:vi(this.options.smartypants?t(i[0]):i[0]),{type:"text",raw:i[0],text:e}}}}const Ri={newline:/^(?: *(?:\n|$))+/,code:/^( {4}[^\n]+(?:\n(?: *(?:\n|$))*)?)+/,fences:/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,hr:/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,heading:/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,blockquote:/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/,list:/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/,html:"^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n *)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$))",def:/^ {0,3}\[(label)\]: *(?:\n *)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n *)?| *\n *)(title))? *(?:\n+|$)/,table:Ui,lheading:/^((?:.|\n(?!\n))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,_paragraph:/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,text:/^[^\n]+/,_label:/(?!\s*\])(?:\\.|[^\[\]\\])+/,_title:/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/};Ri.def=yi(Ri.def).replace("label",Ri._label).replace("title",Ri._title).getRegex(),Ri.bullet=/(?:[*+-]|\d{1,9}[.)])/,Ri.listItemStart=yi(/^( *)(bull) */).replace("bull",Ri.bullet).getRegex(),Ri.list=yi(Ri.list).replace(/bull/g,Ri.bullet).replace("hr","\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def","\\n+(?="+Ri.def.source+")").getRegex(),Ri._tag="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Ri._comment=/<!--(?!-?>)[\s\S]*?(?:-->|$)/,Ri.html=yi(Ri.html,"i").replace("comment",Ri._comment).replace("tag",Ri._tag).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Ri.paragraph=yi(Ri._paragraph).replace("hr",Ri.hr).replace("heading"," {0,3}#{1,6} ").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ri._tag).getRegex(),Ri.blockquote=yi(Ri.blockquote).replace("paragraph",Ri.paragraph).getRegex(),Ri.normal={...Ri},Ri.gfm={...Ri.normal,table:"^ *([^\\n ].*\\|.*)\\n {0,3}(?:\\| *)?(:?-+:? *(?:\\| *:?-+:? *)*)(?:\\| *)?(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)"},Ri.gfm.table=yi(Ri.gfm.table).replace("hr",Ri.hr).replace("heading"," {0,3}#{1,6} ").replace("blockquote"," {0,3}>").replace("code"," {4}[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ri._tag).getRegex(),Ri.gfm.paragraph=yi(Ri._paragraph).replace("hr",Ri.hr).replace("heading"," {0,3}#{1,6} ").replace("|lheading","").replace("table",Ri.gfm.table).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ri._tag).getRegex(),Ri.pedantic={...Ri.normal,html:yi("^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:\"[^\"]*\"|'[^']*'|\\s[^'\"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))").replace("comment",Ri._comment).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Ui,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:yi(Ri.normal._paragraph).replace("hr",Ri.hr).replace("heading"," *#{1,6} *[^\n]").replace("lheading",Ri.lheading).replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").getRegex()};const Oi={escape:/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,autolink:/^<(scheme:[^\s\x00-\x1f<>]*|email)>/,url:Ui,tag:"^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>",link:/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/,reflink:/^!?\[(label)\]\[(ref)\]/,nolink:/^!?\[(ref)\](?:\[\])?/,reflinkSearch:"reflink|nolink(?!\\()",emStrong:{lDelim:/^(?:\*+(?:([punct_])|[^\s*]))|^_+(?:([punct*])|([^\s_]))/,rDelimAst:/^(?:[^_*\\]|\\.)*?\_\_(?:[^_*\\]|\\.)*?\*(?:[^_*\\]|\\.)*?(?=\_\_)|(?:[^*\\]|\\.)+(?=[^*])|[punct_](\*+)(?=[\s]|$)|(?:[^punct*_\s\\]|\\.)(\*+)(?=[punct_\s]|$)|[punct_\s](\*+)(?=[^punct*_\s])|[\s](\*+)(?=[punct_])|[punct_](\*+)(?=[punct_])|(?:[^punct*_\s\\]|\\.)(\*+)(?=[^punct*_\s])/,rDelimUnd:/^(?:[^_*\\]|\\.)*?\*\*(?:[^_*\\]|\\.)*?\_(?:[^_*\\]|\\.)*?(?=\*\*)|(?:[^_\\]|\\.)+(?=[^_])|[punct*](\_+)(?=[\s]|$)|(?:[^punct*_\s\\]|\\.)(\_+)(?=[punct*\s]|$)|[punct*\s](\_+)(?=[^punct*_\s])|[\s](\_+)(?=[punct*])|[punct*](\_+)(?=[punct*])/},code:/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,br:/^( {2,}|\\)\n(?!\s*$)/,del:Ui,text:/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,punctuation:/^([\spunctuation])/};function Ni(e){return e.replace(/---/g,"—").replace(/--/g,"–").replace(/(^|[-\u2014/(\[{"\s])'/g,"$1‘").replace(/'/g,"’").replace(/(^|[-\u2014/(\[{\u2018\s])"/g,"$1“").replace(/"/g,"”").replace(/\.{3}/g,"…")}function qi(e){let t,i,a="";const r=e.length;for(t=0;t<r;t++)i=e.charCodeAt(t),Math.random()>.5&&(i="x"+i.toString(16)),a+="&#"+i+";";return a}Oi._punctuation="!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~",Oi.punctuation=yi(Oi.punctuation).replace(/punctuation/g,Oi._punctuation).getRegex(),Oi.blockSkip=/\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g,Oi.escapedEmSt=/(?:^|[^\\])(?:\\\\)*\\[*_]/g,Oi._comment=yi(Ri._comment).replace("(?:--\x3e|$)","--\x3e").getRegex(),Oi.emStrong.lDelim=yi(Oi.emStrong.lDelim).replace(/punct/g,Oi._punctuation).getRegex(),Oi.emStrong.rDelimAst=yi(Oi.emStrong.rDelimAst,"g").replace(/punct/g,Oi._punctuation).getRegex(),Oi.emStrong.rDelimUnd=yi(Oi.emStrong.rDelimUnd,"g").replace(/punct/g,Oi._punctuation).getRegex(),Oi._escapes=/\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g,Oi._scheme=/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/,Oi._email=/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/,Oi.autolink=yi(Oi.autolink).replace("scheme",Oi._scheme).replace("email",Oi._email).getRegex(),Oi._attribute=/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/,Oi.tag=yi(Oi.tag).replace("comment",Oi._comment).replace("attribute",Oi._attribute).getRegex(),Oi._label=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,Oi._href=/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/,Oi._title=/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,Oi.link=yi(Oi.link).replace("label",Oi._label).replace("href",Oi._href).replace("title",Oi._title).getRegex(),Oi.reflink=yi(Oi.reflink).replace("label",Oi._label).replace("ref",Ri._label).getRegex(),Oi.nolink=yi(Oi.nolink).replace("ref",Ri._label).getRegex(),Oi.reflinkSearch=yi(Oi.reflinkSearch,"g").replace("reflink",Oi.reflink).replace("nolink",Oi.nolink).getRegex(),Oi.normal={...Oi},Oi.pedantic={...Oi.normal,strong:{start:/^__|\*\*/,middle:/^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/,endAst:/\*\*(?!\*)/g,endUnd:/__(?!_)/g},em:{start:/^_|\*/,middle:/^()\*(?=\S)([\s\S]*?\S)\*(?!\*)|^_(?=\S)([\s\S]*?\S)_(?!_)/,endAst:/\*(?!\*)/g,endUnd:/_(?!_)/g},link:yi(/^!?\[(label)\]\((.*?)\)/).replace("label",Oi._label).getRegex(),reflink:yi(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Oi._label).getRegex()},Oi.gfm={...Oi.normal,escape:yi(Oi.escape).replace("])","~|])").getRegex(),_extended_email:/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/,url:/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])([\s\S]*?[^\s~])\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},Oi.gfm.url=yi(Oi.gfm.url,"i").replace("email",Oi.gfm._extended_email).getRegex(),Oi.breaks={...Oi.gfm,br:yi(Oi.br).replace("{2,}","*").getRegex(),text:yi(Oi.gfm.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()};class Mi{constructor(e){this.tokens=[],this.tokens.links=Object.create(null),this.options=e||hi,this.options.tokenizer=this.options.tokenizer||new Ei,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};const t={block:Ri.normal,inline:Oi.normal};this.options.pedantic?(t.block=Ri.pedantic,t.inline=Oi.pedantic):this.options.gfm&&(t.block=Ri.gfm,this.options.breaks?t.inline=Oi.breaks:t.inline=Oi.gfm),this.tokenizer.rules=t}static get rules(){return{block:Ri,inline:Oi}}static lex(e,t){return new Mi(t).lex(e)}static lexInline(e,t){return new Mi(t).inlineTokens(e)}lex(e){let t;for(e=e.replace(/\r\n|\r/g,"\n"),this.blockTokens(e,this.tokens);t=this.inlineQueue.shift();)this.inlineTokens(t.src,t.tokens);return this.tokens}blockTokens(e,t=[]){let i,a,r,s;for(e=this.options.pedantic?e.replace(/\t/g,"    ").replace(/^ +$/gm,""):e.replace(/^( *)(\t+)/gm,((e,t,i)=>t+"    ".repeat(i.length)));e;)if(!(this.options.extensions&&this.options.extensions.block&&this.options.extensions.block.some((a=>!!(i=a.call({lexer:this},e,t))&&(e=e.substring(i.raw.length),t.push(i),!0)))))if(i=this.tokenizer.space(e))e=e.substring(i.raw.length),1===i.raw.length&&t.length>0?t[t.length-1].raw+="\n":t.push(i);else if(i=this.tokenizer.code(e))e=e.substring(i.raw.length),a=t[t.length-1],!a||"paragraph"!==a.type&&"text"!==a.type?t.push(i):(a.raw+="\n"+i.raw,a.text+="\n"+i.text,this.inlineQueue[this.inlineQueue.length-1].src=a.text);else if(i=this.tokenizer.fences(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.heading(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.hr(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.blockquote(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.list(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.html(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.def(e))e=e.substring(i.raw.length),a=t[t.length-1],!a||"paragraph"!==a.type&&"text"!==a.type?this.tokens.links[i.tag]||(this.tokens.links[i.tag]={href:i.href,title:i.title}):(a.raw+="\n"+i.raw,a.text+="\n"+i.raw,this.inlineQueue[this.inlineQueue.length-1].src=a.text);else if(i=this.tokenizer.table(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.lheading(e))e=e.substring(i.raw.length),t.push(i);else{if(r=e,this.options.extensions&&this.options.extensions.startBlock){let t=1/0;const i=e.slice(1);let a;this.options.extensions.startBlock.forEach((function(e){a=e.call({lexer:this},i),"number"==typeof a&&a>=0&&(t=Math.min(t,a))})),t<1/0&&t>=0&&(r=e.substring(0,t+1))}if(this.state.top&&(i=this.tokenizer.paragraph(r)))a=t[t.length-1],s&&"paragraph"===a.type?(a.raw+="\n"+i.raw,a.text+="\n"+i.text,this.inlineQueue.pop(),this.inlineQueue[this.inlineQueue.length-1].src=a.text):t.push(i),s=r.length!==e.length,e=e.substring(i.raw.length);else if(i=this.tokenizer.text(e))e=e.substring(i.raw.length),a=t[t.length-1],a&&"text"===a.type?(a.raw+="\n"+i.raw,a.text+="\n"+i.text,this.inlineQueue.pop(),this.inlineQueue[this.inlineQueue.length-1].src=a.text):t.push(i);else if(e){const t="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(t);break}throw new Error(t)}}return this.state.top=!0,t}inline(e,t=[]){return this.inlineQueue.push({src:e,tokens:t}),t}inlineTokens(e,t=[]){let i,a,r,s,o,n,l=e;if(this.tokens.links){const e=Object.keys(this.tokens.links);if(e.length>0)for(;null!=(s=this.tokenizer.rules.inline.reflinkSearch.exec(l));)e.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(l=l.slice(0,s.index)+"["+Li("a",s[0].length-2)+"]"+l.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;null!=(s=this.tokenizer.rules.inline.blockSkip.exec(l));)l=l.slice(0,s.index)+"["+Li("a",s[0].length-2)+"]"+l.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;null!=(s=this.tokenizer.rules.inline.escapedEmSt.exec(l));)l=l.slice(0,s.index+s[0].length-2)+"++"+l.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex),this.tokenizer.rules.inline.escapedEmSt.lastIndex--;for(;e;)if(o||(n=""),o=!1,!(this.options.extensions&&this.options.extensions.inline&&this.options.extensions.inline.some((a=>!!(i=a.call({lexer:this},e,t))&&(e=e.substring(i.raw.length),t.push(i),!0)))))if(i=this.tokenizer.escape(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.tag(e))e=e.substring(i.raw.length),a=t[t.length-1],a&&"text"===i.type&&"text"===a.type?(a.raw+=i.raw,a.text+=i.text):t.push(i);else if(i=this.tokenizer.link(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.reflink(e,this.tokens.links))e=e.substring(i.raw.length),a=t[t.length-1],a&&"text"===i.type&&"text"===a.type?(a.raw+=i.raw,a.text+=i.text):t.push(i);else if(i=this.tokenizer.emStrong(e,l,n))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.codespan(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.br(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.del(e))e=e.substring(i.raw.length),t.push(i);else if(i=this.tokenizer.autolink(e,qi))e=e.substring(i.raw.length),t.push(i);else if(this.state.inLink||!(i=this.tokenizer.url(e,qi))){if(r=e,this.options.extensions&&this.options.extensions.startInline){let t=1/0;const i=e.slice(1);let a;this.options.extensions.startInline.forEach((function(e){a=e.call({lexer:this},i),"number"==typeof a&&a>=0&&(t=Math.min(t,a))})),t<1/0&&t>=0&&(r=e.substring(0,t+1))}if(i=this.tokenizer.inlineText(r,Ni))e=e.substring(i.raw.length),"_"!==i.raw.slice(-1)&&(n=i.raw.slice(-1)),o=!0,a=t[t.length-1],a&&"text"===a.type?(a.raw+=i.raw,a.text+=i.text):t.push(i);else if(e){const t="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(t);break}throw new Error(t)}}else e=e.substring(i.raw.length),t.push(i);return t}}class Fi{constructor(e){this.options=e||hi}code(e,t,i){const a=(t||"").match(/\S*/)[0];if(this.options.highlight){const t=this.options.highlight(e,a);null!=t&&t!==e&&(i=!0,e=t)}return e=e.replace(/\n$/,"")+"\n",a?'<pre><code class="'+this.options.langPrefix+vi(a)+'">'+(i?e:vi(e,!0))+"</code></pre>\n":"<pre><code>"+(i?e:vi(e,!0))+"</code></pre>\n"}blockquote(e){return`<blockquote>\n${e}</blockquote>\n`}html(e){return e}heading(e,t,i,a){if(this.options.headerIds){return`<h${t} id="${this.options.headerPrefix+a.slug(i)}">${e}</h${t}>\n`}return`<h${t}>${e}</h${t}>\n`}hr(){return this.options.xhtml?"<hr/>\n":"<hr>\n"}list(e,t,i){const a=t?"ol":"ul";return"<"+a+(t&&1!==i?' start="'+i+'"':"")+">\n"+e+"</"+a+">\n"}listitem(e){return`<li>${e}</li>\n`}checkbox(e){return"<input "+(e?'checked="" ':"")+'disabled="" type="checkbox"'+(this.options.xhtml?" /":"")+"> "}paragraph(e){return`<p>${e}</p>\n`}table(e,t){return t&&(t=`<tbody>${t}</tbody>`),"<table>\n<thead>\n"+e+"</thead>\n"+t+"</table>\n"}tablerow(e){return`<tr>\n${e}</tr>\n`}tablecell(e,t){const i=t.header?"th":"td";return(t.align?`<${i} align="${t.align}">`:`<${i}>`)+e+`</${i}>\n`}strong(e){return`<strong>${e}</strong>`}em(e){return`<em>${e}</em>`}codespan(e){return`<code>${e}</code>`}br(){return this.options.xhtml?"<br/>":"<br>"}del(e){return`<del>${e}</del>`}link(e,t,i){if(null===(e=_i(this.options.sanitize,this.options.baseUrl,e)))return i;let a='<a href="'+e+'"';return t&&(a+=' title="'+t+'"'),a+=">"+i+"</a>",a}image(e,t,i){if(null===(e=_i(this.options.sanitize,this.options.baseUrl,e)))return i;let a=`<img src="${e}" alt="${i}"`;return t&&(a+=` title="${t}"`),a+=this.options.xhtml?"/>":">",a}text(e){return e}}class Bi{strong(e){return e}em(e){return e}codespan(e){return e}del(e){return e}html(e){return e}text(e){return e}link(e,t,i){return""+i}image(e,t,i){return""+i}br(){return""}}class ji{constructor(){this.seen={}}serialize(e){return e.toLowerCase().trim().replace(/<[!\/a-z].*?>/gi,"").replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g,"").replace(/\s/g,"-")}getNextSafeSlug(e,t){let i=e,a=0;if(this.seen.hasOwnProperty(i)){a=this.seen[e];do{a++,i=e+"-"+a}while(this.seen.hasOwnProperty(i))}return t||(this.seen[e]=a,this.seen[i]=0),i}slug(e,t={}){const i=this.serialize(e);return this.getNextSafeSlug(i,t.dryrun)}}class Hi{constructor(e){this.options=e||hi,this.options.renderer=this.options.renderer||new Fi,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new Bi,this.slugger=new ji}static parse(e,t){return new Hi(t).parse(e)}static parseInline(e,t){return new Hi(t).parseInline(e)}parse(e,t=!0){let i,a,r,s,o,n,l,c,d,h,p,u,f,b,m,g,v,w,x,k="";const y=e.length;for(i=0;i<y;i++)if(h=e[i],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[h.type]&&(x=this.options.extensions.renderers[h.type].call({parser:this},h),!1!==x||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(h.type)))k+=x||"";else switch(h.type){case"space":continue;case"hr":k+=this.renderer.hr();continue;case"heading":k+=this.renderer.heading(this.parseInline(h.tokens),h.depth,xi(this.parseInline(h.tokens,this.textRenderer)),this.slugger);continue;case"code":k+=this.renderer.code(h.text,h.lang,h.escaped);continue;case"table":for(c="",l="",s=h.header.length,a=0;a<s;a++)l+=this.renderer.tablecell(this.parseInline(h.header[a].tokens),{header:!0,align:h.align[a]});for(c+=this.renderer.tablerow(l),d="",s=h.rows.length,a=0;a<s;a++){for(n=h.rows[a],l="",o=n.length,r=0;r<o;r++)l+=this.renderer.tablecell(this.parseInline(n[r].tokens),{header:!1,align:h.align[r]});d+=this.renderer.tablerow(l)}k+=this.renderer.table(c,d);continue;case"blockquote":d=this.parse(h.tokens),k+=this.renderer.blockquote(d);continue;case"list":for(p=h.ordered,u=h.start,f=h.loose,s=h.items.length,d="",a=0;a<s;a++)m=h.items[a],g=m.checked,v=m.task,b="",m.task&&(w=this.renderer.checkbox(g),f?m.tokens.length>0&&"paragraph"===m.tokens[0].type?(m.tokens[0].text=w+" "+m.tokens[0].text,m.tokens[0].tokens&&m.tokens[0].tokens.length>0&&"text"===m.tokens[0].tokens[0].type&&(m.tokens[0].tokens[0].text=w+" "+m.tokens[0].tokens[0].text)):m.tokens.unshift({type:"text",text:w}):b+=w),b+=this.parse(m.tokens,f),d+=this.renderer.listitem(b,v,g);k+=this.renderer.list(d,p,u);continue;case"html":k+=this.renderer.html(h.text);continue;case"paragraph":k+=this.renderer.paragraph(this.parseInline(h.tokens));continue;case"text":for(d=h.tokens?this.parseInline(h.tokens):h.text;i+1<y&&"text"===e[i+1].type;)h=e[++i],d+="\n"+(h.tokens?this.parseInline(h.tokens):h.text);k+=t?this.renderer.paragraph(d):d;continue;default:{const e='Token with "'+h.type+'" type was not found.';if(this.options.silent)return void console.error(e);throw new Error(e)}}return k}parseInline(e,t){t=t||this.renderer;let i,a,r,s="";const o=e.length;for(i=0;i<o;i++)if(a=e[i],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[a.type]&&(r=this.options.extensions.renderers[a.type].call({parser:this},a),!1!==r||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(a.type)))s+=r||"";else switch(a.type){case"escape":case"text":s+=t.text(a.text);break;case"html":s+=t.html(a.text);break;case"link":s+=t.link(a.href,a.title,this.parseInline(a.tokens,t));break;case"image":s+=t.image(a.href,a.title,a.text);break;case"strong":s+=t.strong(this.parseInline(a.tokens,t));break;case"em":s+=t.em(this.parseInline(a.tokens,t));break;case"codespan":s+=t.codespan(a.text);break;case"br":s+=t.br();break;case"del":s+=t.del(this.parseInline(a.tokens,t));break;default:{const e='Token with "'+a.type+'" type was not found.';if(this.options.silent)return void console.error(e);throw new Error(e)}}return s}}class Wi{constructor(e){this.options=e||hi}static passThroughHooks=new Set(["preprocess","postprocess"]);preprocess(e){return e}postprocess(e){return e}}function Gi(e,t){return(i,a,r)=>{"function"==typeof a&&(r=a,a=null);const s={...a},o=function(e,t,i){return a=>{if(a.message+="\nPlease report this to https://github.com/markedjs/marked.",e){const e="<p>An error occurred:</p><pre>"+vi(a.message+"",!0)+"</pre>";return t?Promise.resolve(e):i?void i(null,e):e}if(t)return Promise.reject(a);if(!i)throw a;i(a)}}((a={...Vi.defaults,...s}).silent,a.async,r);if(null==i)return o(new Error("marked(): input parameter is undefined or null"));if("string"!=typeof i)return o(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(i)+", string expected"));if(function(e){e&&e.sanitize&&!e.silent&&console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options")}(a),a.hooks&&(a.hooks.options=a),r){const s=a.highlight;let n;try{a.hooks&&(i=a.hooks.preprocess(i)),n=e(i,a)}catch(e){return o(e)}const l=function(e){let i;if(!e)try{a.walkTokens&&Vi.walkTokens(n,a.walkTokens),i=t(n,a),a.hooks&&(i=a.hooks.postprocess(i))}catch(t){e=t}return a.highlight=s,e?o(e):r(null,i)};if(!s||s.length<3)return l();if(delete a.highlight,!n.length)return l();let c=0;return Vi.walkTokens(n,(function(e){"code"===e.type&&(c++,setTimeout((()=>{s(e.text,e.lang,(function(t,i){if(t)return l(t);null!=i&&i!==e.text&&(e.text=i,e.escaped=!0),c--,0===c&&l()}))}),0))})),void(0===c&&l())}if(a.async)return Promise.resolve(a.hooks?a.hooks.preprocess(i):i).then((t=>e(t,a))).then((e=>a.walkTokens?Promise.all(Vi.walkTokens(e,a.walkTokens)).then((()=>e)):e)).then((e=>t(e,a))).then((e=>a.hooks?a.hooks.postprocess(e):e)).catch(o);try{a.hooks&&(i=a.hooks.preprocess(i));const r=e(i,a);a.walkTokens&&Vi.walkTokens(r,a.walkTokens);let s=t(r,a);return a.hooks&&(s=a.hooks.postprocess(s)),s}catch(e){return o(e)}}}function Vi(e,t,i){return Gi(Mi.lex,Hi.parse)(e,t,i)}Vi.options=Vi.setOptions=function(e){var t;return Vi.defaults={...Vi.defaults,...e},t=Vi.defaults,hi=t,Vi},Vi.getDefaults=di,Vi.defaults=hi,Vi.use=function(...e){const t=Vi.defaults.extensions||{renderers:{},childTokens:{}};e.forEach((e=>{const i={...e};if(i.async=Vi.defaults.async||i.async||!1,e.extensions&&(e.extensions.forEach((e=>{if(!e.name)throw new Error("extension name required");if(e.renderer){const i=t.renderers[e.name];t.renderers[e.name]=i?function(...t){let a=e.renderer.apply(this,t);return!1===a&&(a=i.apply(this,t)),a}:e.renderer}if(e.tokenizer){if(!e.level||"block"!==e.level&&"inline"!==e.level)throw new Error("extension level must be 'block' or 'inline'");t[e.level]?t[e.level].unshift(e.tokenizer):t[e.level]=[e.tokenizer],e.start&&("block"===e.level?t.startBlock?t.startBlock.push(e.start):t.startBlock=[e.start]:"inline"===e.level&&(t.startInline?t.startInline.push(e.start):t.startInline=[e.start]))}e.childTokens&&(t.childTokens[e.name]=e.childTokens)})),i.extensions=t),e.renderer){const t=Vi.defaults.renderer||new Fi;for(const i in e.renderer){const a=t[i];t[i]=(...r)=>{let s=e.renderer[i].apply(t,r);return!1===s&&(s=a.apply(t,r)),s}}i.renderer=t}if(e.tokenizer){const t=Vi.defaults.tokenizer||new Ei;for(const i in e.tokenizer){const a=t[i];t[i]=(...r)=>{let s=e.tokenizer[i].apply(t,r);return!1===s&&(s=a.apply(t,r)),s}}i.tokenizer=t}if(e.hooks){const t=Vi.defaults.hooks||new Wi;for(const i in e.hooks){const a=t[i];Wi.passThroughHooks.has(i)?t[i]=r=>{if(Vi.defaults.async)return Promise.resolve(e.hooks[i].call(t,r)).then((e=>a.call(t,e)));const s=e.hooks[i].call(t,r);return a.call(t,s)}:t[i]=(...r)=>{let s=e.hooks[i].apply(t,r);return!1===s&&(s=a.apply(t,r)),s}}i.hooks=t}if(e.walkTokens){const t=Vi.defaults.walkTokens;i.walkTokens=function(i){let a=[];return a.push(e.walkTokens.call(this,i)),t&&(a=a.concat(t.call(this,i))),a}}Vi.setOptions(i)}))},Vi.walkTokens=function(e,t){let i=[];for(const a of e)switch(i=i.concat(t.call(Vi,a)),a.type){case"table":for(const e of a.header)i=i.concat(Vi.walkTokens(e.tokens,t));for(const e of a.rows)for(const a of e)i=i.concat(Vi.walkTokens(a.tokens,t));break;case"list":i=i.concat(Vi.walkTokens(a.items,t));break;default:Vi.defaults.extensions&&Vi.defaults.extensions.childTokens&&Vi.defaults.extensions.childTokens[a.type]?Vi.defaults.extensions.childTokens[a.type].forEach((function(e){i=i.concat(Vi.walkTokens(a[e],t))})):a.tokens&&(i=i.concat(Vi.walkTokens(a.tokens,t)))}return i},Vi.parseInline=Gi(Mi.lexInline,Hi.parseInline),Vi.Parser=Hi,Vi.parser=Hi.parse,Vi.Renderer=Fi,Vi.TextRenderer=Bi,Vi.Lexer=Mi,Vi.lexer=Mi.lex,Vi.Tokenizer=Ei,Vi.Slugger=ji,Vi.Hooks=Wi,Vi.parse=Vi;Vi.options,Vi.setOptions,Vi.use,Vi.walkTokens,Vi.parseInline,Hi.parse,Mi.lex;class Ki extends oe{constructor(){super(),this.collInfo=null,this.curatedPageMap={},this.currList=0,this.active=!1,this.lastST=0,this.clickTime=0,this.isSidebar=!1,this.splitDirection=!1}static get properties(){return{collInfo:{type:Object},active:{type:Boolean},curatedPageMap:{type:Object},currList:{type:Number},isSidebar:{type:Boolean},splitDirection:{type:Boolean}}}recalcSplitter(e){this.splitDirection=this.isSidebar||e<769?"vertical":"horizontal"}firstUpdated(){this.recalcSplitter(document.documentElement.clientWidth),this.obs=new ResizeObserver((e=>{this.recalcSplitter(e[0].contentRect.width)})),this.obs.observe(this)}updated(e){e.has("collInfo")&&this.doLoadCurated(),(e.has("collInfo")||e.has("isSidebar"))&&this.recalcSplitter(document.documentElement.clientWidth),e.has("splitDirection")&&this.configureSplitter(),e.has("currList")&&this.active&&this.sendChangeEvent({currList:this.currList})}configureSplitter(){const e=this.renderRoot.querySelector(".sidebar"),t=this.renderRoot.querySelector(".main-content");if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}if(e&&t&&!this.splitter){const i={sizes:[20,80],gutterSize:4,direction:this.splitDirection};this.splitter=ni([e,t],i)}}async doLoadCurated(){this.curatedPageMap={};const e={};for(const t of this.collInfo.pages)e[t.id]=t;for(const e of this.collInfo.curatedPages){this.curatedPageMap[e.list]||(this.curatedPageMap[e.list]=[]);const t=e,i=t.url,a=t.ts,r=t.title||t.url,s=e.desc;this.curatedPageMap[e.list].push({url:i,ts:a,title:r,desc:s})}this.scrollToList()}static get styles(){return Se(o`
      :host {
        width: 100%;
        height: 100%;
        display: flex;
      ...
      ${Ki.sidebarStyles(s(":host(.sidebar)"))}
    ...
    `}render(){const e=this.currList;return M`
      <div
        class="is-sr-only"
        role="heading"
      ...
      <div class="columns">
          ...
          <aside class="menu">
            <ul class="menu-list">
              <li>
                ...
                >
                <ul class="menu-list">
                  ${this.collInfo.lists.map((t=>M` <li>
                        <a
                          @click=${this.onClickScroll}
                          href="#list-${t.id}"
                          data-list="${t.id}"
        ...
        <div @scroll=${this.onScroll} class="column main-content main-scroll">
          <section id="list-0" class="desc">
            ...
            ${this.collInfo.desc?ue(Vi(this.collInfo.desc)):""}
          </section>
          ${this.renderLists()}
        </div>
      </div>
    `}renderLists(){return M` ${this.collInfo.lists.map((e=>M`
        <article id="list-${e.id}">
          <div class="content">
            ...
            <p>${e.desc}</p>
            <ol>
              ${this.curatedPageMap[e.id]?this.curatedPageMap[e.id].map((e=>this.renderCPage(e))):M``}
            </ol>
          </div>
        </article>
      `))}`}renderCPage(e){const t=new Date(e.ts),i=rt(t.toISOString());return M` <li>
      <div class="content">
        <a
          @click="${this.onReplay}"
          data-url="${e.url}"
      ...
      <hr />
    </li>`}onReplay(e){e.preventDefault();const t={url:e.currentTarget.getAttribute("data-url"),ts:e.currentTarget.getAttribute("data-ts")};return this.sendChangeEvent(t),!1}sendChangeEvent(e){this.dispatchEvent(new CustomEvent("coll-tab-nav",{detail:{data:e}}))}onClickScroll(e){return e.preventDefault(),this.currList=Number(e.currentTarget.getAttribute("data-list")),this.scrollToList(),!1}scrollToList(){this.currList>this.collInfo.lists.length&&(this.currList=0);const e={behavior:"smooth",block:"nearest",inline:"nearest"};this.clickTime=(new Date).getTime();const t=this.renderRoot.getElementById("list-"+this.currList);t&&t.scrollIntoView(e)}onScroll(e){const t=e.currentTarget,i=this.renderRoot.getElementById("list-"+this.currList);if(!i)return;let a=i;const r=t.offsetTop,s=t.scrollTop;if(s>this.lastST)for(;a.nextElementSibling&&a.nextElementSibling.getBoundingClientRect().top<r;)a=a.nextElementSibling;else for(;a.previousElementSibling&&a.previousElementSibling.getBoundingClientRect().bottom>=r;)a=a.previousElementSibling;if(this.lastST=s,a&&a!=i&&a.id.startsWith("list-")&&(this.currList=Number(a.id.slice(5))),(new Date).getTime()-this.clickTime<1e3)return;const o=this.renderRoot.querySelector(`a[data-list="${this.currList}"]`);if(o){const e={behavior:"smooth",block:"nearest",inline:"nearest"};o.scrollIntoView(e)}}}customElements.define("wr-coll-story",Ki);var Zi=__webpack_require__(4722),Ji=__webpack_require__.n(Zi);customElements.define("wr-gdrive",class extends oe{constructor(){super(),this.state="trypublic",this.sourceUrl="",this.scriptLoaded=!1,this.error=!1}static get properties(){return{state:{type:String},sourceUrl:{type:String},error:{type:Boolean},reauth:{type:Boolean}}}updated(e){e.has("sourceUrl")&&(this.error=!1,this.state="trypublic",this.tryPublicAccess().then((e=>{e||(this.state="tryauto",this.requestUpdate())})))}async tryPublicAccess(){try{const e=this.sourceUrl,t=e.slice(14),i=`${__HELPER_PROXY__}/g/${t}`;let a=null;try{a=await fetch(i)}catch(e){return!1}const r=await a.json();if(!r.url||!r.name||!r.size)return!1;if(r.size>15e6)return!1;const s=r.url;try{const e=new AbortController,t=e.signal;if(a=await fetch(s,{signal:t}),e.abort(),200!=a.status)return!1}catch(e){return!1}const o=r.name,n={publicUrl:s},l=Number(r.size);return this.dispatchEvent(new CustomEvent("load-ready",{detail:{name:o,extra:n,size:l,sourceUrl:e}})),!0}catch(e){return!1}}onLoad(){this.scriptLoaded=!0,this.gauth("none",(e=>{e.error?"implicitonly"!==this.state&&(this.state="trymanual"):this.authed(e)}))}onClickAuth(){this.gauth("select_account",(e=>{e.error||this.authed(e)}))}async authed(e){const t=this.sourceUrl,i=`https://www.googleapis.com/drive/v3/files/${t.slice(14)}`,a={Authorization:`Bearer ${e.access_token}`},r=await fetch(i+"?fields=name,size&supportsAllDrives=true",{headers:a});if(404===r.status||403==r.status)return"implicitonly"!==this.state&&(this.state="trymanual"),void(this.error=!0);this.error=!1;const s=await r.json(),o=s.name,n=Number(s.size);this.dispatchEvent(new CustomEvent("load-ready",{detail:{sourceUrl:t,headers:a,size:n,name:o}}))}static get styles(){return Se(o``)}render(){return M` ${this.script()}
    ${"trymanual"!==this.state?M` <p>Connecting to Google Drive...</p> `:M`
          ${this.error?M`
    ...
    `}renderContent(){switch(this.state){case"googledrive":return M`<wr-gdrive
          .sourceUrl=${this.sourceUrl}
          @load-ready=${this.onLoadReady}
        ></wr-gdrive>`;case"started":return M` <div class="progress-div">
          <progress
            id="progress"
          ...
          ${this.currentSize&&this.totalSize?M` <div class="loaded-prog">
                Loaded <b>${We()(this.currentSize)}</b> of
                <b>${We()(this.totalSize)}</b>
                ${this.extraMsg&&M` <p class="extra-msg">(${this.extraMsg})</p> `}
              </div>`:M``}
          ${this.embed?"":M` <button @click="${this.onCancel}" class="button is-danger">
                Cancel
              </button>`}
        </div>`;case"errored":return M` <div class="has-text-left">
          <div class="error has-text-danger">${this.error}</div>
          <div>
            ${this.errorAllowRetry?M` <a
                  class="button is-warning"
                  @click=${()=>window.parent.location.reload()}
                  >Try Again</a
                >`:""}
            ${this.embed?M``:M` <a href="/" class="button is-warning">Back</a>`}
          </div>
        </div>`;case"permission_needed":return M` <div class="has-text-left">
          <div class="">
      ...
      ${sa.sidebarStyles(s`:host(.sidebar)`)}
    ...
    `}onSelectList(e){e.preventDefault(),this.currList=Number(e.currentTarget.getAttribute("data-list"))}onSelectListDrop(e){e.preventDefault(),this.currList=Number(e.currentTarget.value)}render(){const e=this.currList;return M`
      <div
        class="is-sr-only"
        role="heading"
        aria-level="${this.isSidebar?"2":"1"}"
      ...
      <div class="search-bar notification is-marginless">
        ${this.isSidebar?M`<h3 class="is-sr-only">Search and Filter Pages</h3>`:""}
        <div class="field flex-auto">
          ...
          >
            ...
            <span class="icon is-left"
              ><fa-icon .svg="${Xe()}" aria-hidden="true"></fa-icon
            ></span>
          </div>
        </div>
      </div>
        ...
        >
          ${this.editable&&this.editing?M`
              ...
              `:M` <div
                ...
                ${this.collInfo.description?M`<div
                      class="index-bar-description"
                      @dblclick="${()=>this.editing=!0}"
                    >
                      ${this.collInfo.description}
                    </div>`:M``}`}
          ${this.editable?M`<fa-icon class="editIcon" .svg="${ra()}"></fa-icon>`:M``}
          ${this.hasExtraPages?M` <span class="check-select">
          ...
          >
          ${this.editable?M` <div class="index-bar-actions">
                ${this.renderDownloadMenu()}
              </div>`:""}
          ${this.collInfo.lists.length?M`
    ...
    `}renderDownloadMenu(){return M` <div class="dropdown ${this.menuActive?"is-active":""}">
      <div class="dropdown-trigger">
        <button
          @click="${this.onMenu}"
        ...
        >
          <span>Download</span>
          <span class="icon is-small">
            <fa-icon .svg="${ia()}" aria-hidden="true"></fa-icon>
          </span>
        </button>
      </div>
    ...
    </div>`}renderPageHeader(){return M`
      ${!this.isSidebar&&this.editable&&this.filteredPages.length?M` <div class="check-select">
            <label class="checkbox">
              <input
    ...
    </wr-modal>`:M``}isCurrPage(e){if(this.isSidebar&&e.url===this.url){let t=e.timestamp;return!t&&e.date?t=rt(e.date):"string"==typeof e.ts&&(t=rt(e.ts)),t===this.ts}return!1}renderPages(){return M`
      <div class="page-header has-text-weight-bold">
        ${this.renderPageHeader()}
      </div>
      <ul class="scroller" @scroll="${this.onScroll}">
        ${this.sortedPages.length?M` ${this.sortedPages.map(((e,t)=>{const i=this.selectedPages.has(e.id);return M` <li class="page-entry ${i?"selected":""}">
                <wr-page-entry
    ...
    `}onUpdateTitle(e){if(e.preventDefault(),this.editing=!1,!this.editable)return;const t=this.renderRoot.querySelector("#titleEdit");if(!t||!t.value.trim())return;const i=t.value,a=JSON.stringify({title:i});fetch(`${this.collInfo.apiPrefix}/metadata`,{method:"POST",body:a}).then((e=>{200===e.status&&this.dispatchEvent(new CustomEvent("coll-update",{detail:{title:i}}))}))}onMenu(e){e.stopPropagation(),this.menuActive=!this.menuActive,this.menuActive&&document.addEventListener("click",(()=>{this.menuActive=!1}),{once:!0})}onSort(e){e.preventDefault();const t=e.currentTarget.getAttribute("data-key")||"";t===this.sortKey?this.sortDesc=!this.sortDesc:(this.sortDesc=!1,this.sortKey=t)}onSortChanged(e){this.sortedPages=e.detail.sortedData,this.sortKey=e.detail.sortKey,this.sortDesc=e.detail.sortDesc}onSelectToggle(e){const{page:t,selected:i}=e.detail;i?this.selectedPages.add(t):this.selectedPages.delete(t),this.allSelected=this.selectedPages.size===this.sortedPages.length,this.requestUpdate()}onSelectAll(e){this.allSelected=e.currentTarget.checked,this.allSelected?this.sortedPages.forEach((e=>{this.selectedPages.add(e.id)})):this.selectedPages.clear(),this.requestUpdate()}async onDownload(e,t){e.preventDefault();const i=this.selectedPages.size>0,a=new URLSearchParams;a.set("pages",i?Array.from(this.selectedPages.keys()).join(","):"all"),a.set("format",t),this.collInfo.filename&&a.set("filename",this.collInfo.filename),window.location.href=`${this.collInfo.apiPrefix}/dl?`+a.toString()}onDeleteConfirm(e){const t=e.currentTarget.page;this.selectedPages.has(t.id)?(this.toDeletePages=this.selectedPages,this.toDeletePage=null):(this.toDeletePages=[t.id],this.toDeletePage=t)}async onDeletePages(){const e={};for(const t of this.toDeletePages){const i=this.renderRoot.querySelector(`wr-page-entry[pid="${t}"]`);i&&(i.deleting=!0,e[t]=i)}for(const t of this.toDeletePages){const i=await fetch(`${this.collInfo.apiPrefix}/page/${t}`,{method:"DELETE"}),a=await i.json();if(a.error){console.warn(a.error);continue}const r=e[t];if(!r)continue;const s=this.collInfo.pages.indexOf(r);s<0||this.collInfo.pages.splice(s,1)}this.toDeletePages=null,this.toDeletePage=null,this.updateTextSearch(),this.requestUpdate()}formatResults(){if(!this.query){const e=this.filteredPages.length;return e===this.sortedPages.length?`${e} Page${1!==e?"s":""}`:`${this.sortedPages.length} of ${e} Pages Shown`}return 1===this.sortedPages.length?"1 Page":`${this.sortedPages.length} Pages`}getNoResultsMessage(){return this.collInfo&&this.collInfo.pages.length?this.updatingSearch?"Initializing Search...":this.loading?"Searching...":this.query?M`<span class="fix-text-wrapping"
      ...
      ${ca.sidebarStyles(s`:host(.sidebar)`)}
    ...
    `}updated(e){(e.has("page")||e.has("query"))&&(this.updateSnippet(),this.iconValid=!!this.page.favIconUrl,this.deleting=!1)}render(){const e=this.page,t=this.page.date,i="number"==typeof e.size,a=this.editable&&!this.isSidebar;return M`
      ${a?M` <div class="check-select">
            <label class="checkbox">
              <input
          ...
          <div class="media">
            ...
            <div class="media-content ${this.isCurrent?"current":""}">
              <div role="heading" aria-level="${this.isSidebar?"4":"3"}">
                ...
                ${this.textSnippet?M` <div class="text">
                      <keyword-mark keywords="${this.query}"
                        >${this.textSnippet}</keyword-mark
                      >
                    </div>`:M``}
              </div>
              ${i?M` <div class="media-right" style="margin-right: 2em">
                    ${We()(e.size)}
                  </div>`:""}
            </div>
          </div>
    ...
    `)}render(){const e=`Replay of ${this.title?`${this.title}:`:""} ${this.url}`;return M` <h1 id="replay-heading" class="is-sr-only">${e}</h1>
    ...
    `)}render(){return M`
      ...
      <table class="all-results" aria-labelledby="results-heading num-results">
        ...
        <tbody class="main-scroll" @scroll="${this.onScroll}">
          ${this.sortedResults.length?this.sortedResults.map((e=>M`
    ...
    `)}render(){return M`
      ${this.paramString&&this.hashString&&this.inited?M`
            <iframe
              sandbox="${(e=>null!=e?e:B)(this.sandbox?"allow-downloads allow-modals allow-orientation-lock allow-pointer-lock         allow-popups allow-popups-to-escape-sandbox allow-presentation allow-scripts         allow-same-origin allow-forms":void 0)}"
              @load="${this.onLoad}"
          ...
          `:M``}
      ${this.errorMessage}
    `}onLoad(e){if(this.isCrossOrigin)return;const t=e.target.contentWindow,i=e.target.contentDocument;if(t.navigator.serviceWorker&&!t.navigator.serviceWorker.controller&&this.reloadCount<=2)return this.reloadCount++,void setTimeout((()=>t.location.reload()),100);if(this.reloadCount=0,t.customElements.get(this.mainElementName))return;const a=i.createElement("script");a.src=ba,i.head.appendChild(a)}}!async function(){customElements.define("replay-web-page",ga)}();var va=__webpack_require__(5111),wa=__webpack_require__.n(va),xa=__webpack_require__(504),ka=__webpack_require__.n(xa),ya=__webpack_require__(6420),$a=__webpack_require__.n(ya);class Sa extends ci{constructor(){super(),this._sizeUpdater=null,this.totalSize=0}static get properties(){return{...ci.properties,totalSize:{type:Number},shareOpts:{type:Object}}}static get styles(){return Se(Sa.compStyles)}static get compStyles(){return o`
    .rec-button {
      display: flex;
      flex-direction: row;
      margin: 0 1px;
    ...
    `}updated(e){e.has("embed")&&this.embed&&!this._sizeUpdater&&(this._sizeUpdater=this.runSizeUpdater()),super.updated(e)}async runSizeUpdater(){try{for(;this.embed;){if(this.coll){const e=await fetch(`${ye}/c/${this.coll}`),t=await e.json();this.totalSize=t.size||0}await new Promise((e=>setTimeout(e,3e3)))}}finally{this._sizeUpdater=null}}renderExtraToolbar(e=!1){return this.embed?e?M`
        ...
        <span class="rec-button" title="Archiving">
          <span class="icon is-small" title="Archiving">
            <fa-icon size="1.2em" aria-hidden="true" .svg="${$a()}"></fa-icon>
          </span>
          <span class="size-label">${We()(this.totalSize)}</span>
        </span>
        `:e?"":M`
    <a href="#" role="button"
    class="${e?"dropdown-item is-hidden-tablet":"button narrow is-borderless"}"
      ...
      @click="${this.onShowStart}" @keyup="${Ce}">
      <span class="icon is-small">
        <fa-icon size="1.2em" aria-hidden="true" .svg="${$a()}"></fa-icon>
      </span>
    </a>`}renderCollInfo(){return console.log(this.collInfo),M`
    <div class="info-bg">
      <wr-rec-coll-info
      class="is-list"
      .coll="${this.collInfo}"
      ...
      ?detailed="${!0}"
      ></wr-rec-coll-info>
    </div>`}onShowStart(){if(this.embed)return;const e=this.coll,t=this.collInfo.title,i=this.tabData.url;this.dispatchEvent(new CustomEvent("show-start",{detail:{coll:e,title:t,url:i}}))}}customElements.define("wr-rec-coll",Sa);var _a=__webpack_require__(7050),za=__webpack_require__.n(_a),Ca=__webpack_require__(1294),Ia=__webpack_require__.n(Ca),Aa=__webpack_require__(4688),Ua=__webpack_require__.n(Aa),Pa=__webpack_require__(7087),Da=__webpack_require__.n(Pa),La=__webpack_require__(9671),Ta=__webpack_require__.n(La),Ea=__webpack_require__(9696),Ra=__webpack_require__.n(Ea);class Oa extends tt{constructor(){super(),this.detailed=!1,this.ipfsURL=null,this.shareWait=!1,this.showShareMenu=!1,this.shareWarn=!1,this.shareProgressSize=0,this.shareProgressTotalSize=0}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},ipfsURL:{type:String},shareWait:{type:Boolean},showShareMenu:{type:Boolean},shareWarn:{type:Boolean},shareProgressSize:{type:Number},shareProgressTotalSize:{type:Number},isUploadNeeded:{type:Boolean},shareOpts:{type:Object},btrixOpts:{type:Object},ipfsOpts:{type:Object}}}static get styles(){return Se(Oa.compStyles)}static get compStyles(){return o`
    :host {
      overflow: visible;
    }
    ...
    ${tt.compStyles}
    `}firstUpdated(){this.renderRoot.addEventListener("click",(()=>this.showShareMenu=!1)),this.isUploadNeeded=this.coll&&this.coll.uploadTime&&this.coll.mtime>this.coll.uploadTime}updated(e){if(e.has("shareOpts")&&this.shareOpts){const{ipfsOpts:e,btrixOpts:t}=this.shareOpts;this.ipfsOpts=e,this.btrixOpts=t}e.has("coll")&&this.coll&&("main.archive"===this.coll.id&&"local://main.archive"!==this.coll.sourceUrl&&(this.coll={...this.coll,sourceUrl:"local://main.archive"}),this.coll.ipfsPins&&this.coll.ipfsPins.length&&(this.ipfsURL=this.coll.ipfsPins[this.coll.ipfsPins.length-1].url),this.isUploadNeeded=this.coll&&this.coll.uploadTime&&this.coll.mtime>this.coll.uploadTime)}render(){const e=this.coll,t=this.detailed,i=!!this.btrixOpts,a=!!this.ipfsOpts&&this.ipfsOpts.daemonUrl;return M`
      <div class="columns">
        <div class="column is-2">
        ...
        <div class="column is-2">
          ...
          <div class="button-row is-flex">
            <a href="${ye}/c/${this.coll.id}/dl?format=wacz&pages=all" class="button is-small" title="Download">
              <span class="icon is-small">
                <fa-icon aria-hidden="true" .svg="${dt()}"></fa-icon>
              </span>
            </a>
            ...
            <button @click="${this.onShowStart}" class="button is-small" title="Start Archiving">
              <span class="icon">
                <fa-icon aria-hidden="true" .svg="${$a()}"></fa-icon>
              </span>
            </button>
          </div>
        </div>
        ...
        <div class="column is-3">
          ...
          ${e.loadUrl}
          <a @click="${t=>this.onCopy(t,e.loadUrl)}" class="copy"><fa-icon .svg="${Ve()}"/></a>
        </div>`:""}
      </div>
      ${this.shareWarn?this.renderShareWarn():""}
      `}renderIPFSSharing(){return this.ipfsURL?M`
          ...
          <div class="dropdown-menu" id="dropdown-menu" role="menu" style="z-index: 100">
            <div class="dropdown-content">
              ...
              <a @click="${this.onCopyIPFSLink}" class="dropdown-item">
                <span class="icon is-small">
                  <fa-icon size="0.8em" .svg="${Ua()}"></fa-icon>
                </span>
                Copy IPFS URL
              </a>
      ...
      <div class="is-flex is-flex-direction-column">
        <button class="button is-small ${this.shareWait?"is-loading":""}" @click="${this.onPinOrWarn}">
          <span class="icon is-small">
            <fa-icon .svg="${Ua()}"></fa-icon>
          </span>
          <span>Start</span>
        </button>
        <progress value="${this.shareProgressSize}" max="${this.shareProgressTotalSize}" class="progress is-small ${this.shareProgressTotalSize?"mini":"is-hidden"}"></progress>
      </div>
    `}renderBtrixUpload(){const{uploadId:e,uploadTime:t}=this.coll;return M`
    <div class="is-flex is-flex-direction-column">
      <button @click="${this.onUpload}" class="button is-small" title="Upload to Cloud">
        <span class="icon">
        ${t&&e?this.isUploadNeeded?M`
          <fa-icon aria-hidden="true" class="has-text-warning-dark" .svg="${xt()}"></fa-icon>
          `:M`
          <fa-icon aria-hidden="true" class="has-text-success" .svg="${za()}"></fa-icon>
          `:M`
          <fa-icon aria-hidden="true" size="2.2em" .svg="${Ra()}"></fa-icon>
          `}
        </span>
      </button>
    </div>
    `}renderShareWarn(){return M`
    ...
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.deleteConfirm=null}" title="Confirm Delete">
      ...
      (Size: <b>${We()(this.deleteConfirm.size)}</b>)</p>
    ...
    </wr-modal>`:null}onIpfsShare(e){e.detail.pending?this.ipfsSharePending++:this.ipfsSharePending--}onDeleteColl(e){if(e.preventDefault(),e.stopPropagation(),!this.sortedColls)return;const t=Number(e.currentTarget.getAttribute("data-coll-index"));this.deleteConfirm=this.sortedColls[t]}async doDelete(){if(!this.deleteConfirm)return;this._deleting[this.deleteConfirm.sourceUrl]=!0,this.requestUpdate();const e=this.renderRoot.querySelector(`wr-rec-coll-info[data-coll="${this.deleteConfirm.id}"]`);e&&await e.doDelete(),this.deleteConfirm=null}renderEmpty(){return M`No archived items. Click "New Archiving Session" above to begin archiving pages!`}});var Na=__webpack_require__(3873),qa=__webpack_require__.n(Na);ga.setDefaultReplayFile("replay.html");class Ma extends ga{constructor(){super(),this.replaybase="./replay/",this.replayfile="record.html",this.mainElementName="archive-web-page-app",this.appName="Embedded ArchiveWeb.page",this.embed="default",this.noWebWorker=!0,this.proxyPrefix="https://wabac-cors-proxy.webrecorder.workers.dev/proxy/",this.archivePrefix="";const e=new URL(window.location);e.hash="",this.logo=qa(),this.customConfig={prefix:this.proxyPrefix,isLive:!1,archivePrefix:this.archivePrefix,baseUrl:e.href,baseUrlHashReplay:!1,recording:!0,noPostToGet:!0},this.downloaded=null,this.source="proxy://"+this.proxyPrefix}static get properties(){return{...ga.properties,archivePrefix:{type:String},proxyPrefix:{type:String}}}updated(e){e.has("proxyPrefix")&&(this.customConfig.proxyPrefix=this.proxyPrefix),e.has("archivePrefix")&&(this.customConfig.archivePrefix=this.archivePrefix,this.customConfig.isLive=!this.archivePrefix),super.updated(e)}handleMessage(e){this.downloaded&&"object"==typeof e.data&&"downloadedBlob"===e.data.msg_type&&(this.downloaded(e.data.url),this.downloaded=null)}doDownload(){const e=this.renderRoot.querySelector("iframe");if(!e)return;const t=new Promise((e=>{this.downloaded=e}));return e.contentWindow.postMessage({msg_type:"downloadToBlob"}),t}}!async function(){customElements.define("record-web-page",Ma)}();var Fa=__webpack_require__(3525),Ba=__webpack_require__.n(Fa),ja=__webpack_require__(2740),Ha=__webpack_require__.n(ja);customElements.define("wr-btrix-upload",class extends oe{static get properties(){return{btrixOpts:{type:Object},coll:{type:Object},uploadColl:{type:Object},status:{type:String},uploadId:{type:String},uploadTime:{type:Number},isUploadNeeded:{type:Boolean},actualSize:{type:Number},uploadSize:{type:Number},uploadTotal:{type:Number}}}static get styles(){return Se(o``)}updated(e){if(e.has("uploadColl")){const{coll:e,isUploadNeeded:t}=this.uploadColl;this.coll=e,this.actualSize=0,this.isUploadNeeded=t,this.uploadTime=this.coll.uploadTime,this.uploadId=this.coll.uploadId}e.has("coll")&&this.coll&&this.pollUploadState()}async pollUploadState(){if(this.pollingUploadState)return;this.pollingUploadState=!0;for(;;){const e=await fetch(`${ye}/c/${this.coll.id}/upload`),t=await e.json();if(this.status=t.status,this.uploadTime=t.uploadTime,this.uploadId=t.uploadId,"uploading"===this.status?this.isUploadNeeded=!1:"idle"===this.status&&this.btrixOpts&&this.btrixOpts.client&&t.uploadTime&&t.uploadId&&t.mtime<=t.uploadTime?this.getRemoteUpload():this.uploadId||(this.isUploadNeeded=!0),this.uploadSize=t.size,this.uploadTotal=t.totalSize,"uploading"!==this.status)break;await new Promise((e=>setTimeout(e,1e3)))}this.pollingUploadState=!1}async getRemoteUpload(){try{const e=await this.btrixOpts.client.getRemoteUpload(this.uploadId);this.actualSize=e.fileSize}catch(e){this.isUploadNeeded=!0,this.status="missing"}}render(){if(!this.coll)return M``;const e=this.uploadTime,t=!this.isUploadNeeded&&e;let i="";try{if(this.btrixOpts.client&&this.uploadId){const{client:e}=this.btrixOpts;i=new URL(`/orgs/${e.defaultOrg}/artifacts/upload/${this.uploadId}`,e.url).href}}catch(e){}return M`
      <wr-modal
      ...
      title="Upload To Browsertrix">
        <table class="is-size-6" style="margin-left: 3.0rem">
          ...
          <tr class="is-italic">
            ...
            <td>${We()(this.coll.size)}</td>
          </tr>
          ${this.actualSize?M`
          <tr class="is-italic">
            <td class="has-text-right pr-4">Uploaded Size:</td>
            <td>${We()(this.actualSize)}</td>
          </tr>`:""}
          ${e?M`
          <tr class="is-italic">
          ...
          <tr class="is-italic">
            ...
            <fa-icon aria-hidden="true" class="" size="0.7em" .svg="${Ba()}"></fa-icon>
    ...
    `}renderUploadStatus(){switch(this.status){case"done":return M`<p class="has-text-weight-bold has-text-primary">Upload Finished</p>`;case"failed":return M`<p class="has-text-weight-bold has-text-danger">Sorry, Upload Failed, or, the Browsertrix credentials may be incorrect.</p>;
                  <p>Check your credentials in <i>Settings</i> and then click <b>Upload</b> to try again.</p>`;case"aborted":return M`<p class="has-text-weight-bold has-text-danger">Upload has been canceled</p>`;case"uploading":return M`
          <progress value="${this.uploadSize}" max="${this.uploadTotal}" class="progress is-primary is-small mt-3 mb-1">
          </progress>
          <p class="has-text-centered is-size-7">
            ${We()(this.uploadSize||0)} / ${We()(this.uploadTotal||0)}
          </p>`;case"missing":return M`<p class="has-text-weight-bold has-text-danger">Previously uploaded data not found, or, the Browsertrix credentials may be incorrect.</p>
                  <p>Check your credentials in <i>Settings</i> and then click <b>Upload</b> to try again.</p>`;case"idle":return this.isUploadNeeded?this.uploadId?M`<p class="has-text-weight-bold has-text-warning-dark">
        <fa-icon aria-hidden="true" class="has-text-warning-dark" .svg="${xt()}"></fa-icon>
        Archive updated since last upload. Click "Upload" below to upload latest.
        ${this.renderDeleteUploaded()}
        </p>
        `:M`<p class="has-text-weight-bold has-text-primary">Archive not yet uploaded. Click "Upload" below to start.</p>`:M`<p class="is-italic">
        <fa-icon aria-hidden="true" class="has-text-success" .svg="${za()}"></fa-icon>
        Archive already uploaded to Browsertrix.
        ${this.renderDeleteUploaded()}
        </p>
        `;case"deleted":return M`<p class="has-text-weight-bold has-text-primary">Upload to Browsertrix has been deleted.</p>
      <p>(Data is still saved locally in your browser)</p>`;case"deleteFailed":return M`<p class="has-text-weight-bold has-text-danger">Sorry, deleting upload has failed, or, the Browsertrix credentials may be incorrect.</p>;
                  <p>Check your credentials in <i>Settings</i> and then click <b>Delete</b> to try again.
                  ${this.renderDeleteUploaded()}
                  </p>
                  `;default:return""}}renderDeleteUploaded(){return M`
    <span><button class="button is-small" title="Delete Upload from Browsertrix" type="button" @click="${this.onDeleteUpload}">
    <fa-icon aria-hidden="true" class="has-text-danger pr-2" .svg="${Ha()}"></fa-icon>
    Delete
    </button></span>
    `}async onUpload(){const e=this.btrixOpts.client,t=await e.getOrg(this.btrixOpts.orgName),i=new URL(`/api/orgs/${t}/uploads/stream`,e.url);this.uploadId&&i.searchParams.set("replaceId",this.uploadId);const a=(new Date).toLocaleString();i.searchParams.set("notes",`Uploaded by ArchiveWeb.page 0.12.7 at ${a}`);const r=i.href,s={Authorization:e.auth},o=JSON.stringify({url:r,headers:s});this.status="uploading",this.uploadSize=0,this.uploadTotal=0;const n=await fetch(`${ye}/c/${this.coll.id}/upload?format=wacz&pages=all`,{method:"POST",body:o});(await n.json()).uploading&&this.pollUploadState()}async onCancelUpload(){const e=JSON.stringify({abortUpload:!0});await fetch(`${ye}/c/${this.coll.id}/upload`,{method:"POST",body:e}),this.pollUploadState()}async onDeleteUpload(){try{const{client:e}=this.btrixOpts;if(!e)return;await e.deleteUpload(this.uploadId),await fetch(`${ye}/c/${this.coll.id}/upload`,{method:"DELETE"}),this.status="deleted",this.isUploadNeeded=!0,this.uploadTime=this.btrixOpts.uploadTime=null,this.uploadId=this.btrixOpts.uploadId=null}catch(e){this.status="deleteFailed"}}});class Wa{static async login({url:e,username:t,password:i,orgName:a}){const r=e+"/api/auth/jwt/login",s=new FormData;s.append("username",t),s.append("password",i);const o=await fetch(r,{method:"POST",body:s}),n=await o.json(),{token_type:l,access_token:c}=n;if(!c||!l)throw new Error("Invalid login");const d=new Wa(e,l+" "+c),h=await d.getOrg(a);return d.defaultOrg=h,d}constructor(e,t){this.url=e,this.auth=t,this.defaultOrg=null}async fetchAPI(e,t="GET",i=null){const a={Authorization:this.auth};"GET"!==t&&(a["Content-Type"]="application/json");try{const r=await fetch(this.url+e,{headers:a,method:t,body:i,duplex:"half"});return await r.json()}catch(e){return console.warn(e),{}}}async getOrg(e=""){const t=await this.fetchAPI("/api/users/me"),{orgs:i}=t;if(!i||!i.length)return null;if(!e)return i[0].id;for(const t of i)if(t.slug===e||t.name===e)return t.id;return i[0].id}async getRemoteUpload(e,t=null){const i=this.defaultOrg||t,a=await this.fetchAPI(`/api/orgs/${i}/uploads/${e}`);if(!a.name)throw new Error("upload_missing");return a}async deleteUpload(e,t=null){const i=this.defaultOrg||t,a=JSON.stringify({crawl_ids:[e]});if(!(await this.fetchAPI(`/api/orgs/${i}/uploads/delete`,"POST",a)).deleted)throw new Error("delete_failed")}}const Ga="https://w3s.link/";function Va(e){const{hostname:t,protocol:i,pathname:a}=new URL(e),r=i.slice(0,-1);if(!t){const[e,...t]=a.slice(2).split("/");return{type:r,cid:e,path:"/"+t.join("/")}}return{type:r,cid:t,path:a}}async function Ka(e){return er(e)?e:tr(e)?Ya(e):e}async function Za(e){return new Response(e).blob()}async function*Ja(e){const t=await e.getReader();try{for(;;){const{done:e,value:i}=await t.read();if(e)return;yield i}}finally{t.releaseLock()}}function Ya(e){let t=e;t.next||(t=e[Symbol.asyncIterator]());const i=new TextEncoder;return new ReadableStream({async pull(e){const{value:a,done:r}=await t.next();if(r)await e.close();else{let t=a;"string"==typeof t&&(t=i.encode(t)),await e.enqueue(t)}}})}async function Qa(e){if(!e.ok){const t=await e.text(),i=e.status;throw new Error(`HTTP Error ${i}: ${t}`)}}async function Xa({url:e,file:t,fileName:i="",parameterName:a="file",fetch:r=globalThis.fetch,signal:s}){const o=new FormData,n=new Headers;ir(e,n);const l=await async function(e){if(er(e))return await Za(e);if(tr(e)){const t=Ya(e);return await Za(t)}return e instanceof Blob?e:new Blob([e])}(t);i?o.append(a,l,i):o.append(a,l);const c=await r(e,{method:"POST",body:o,headers:n,signal:s});return await Qa(c),c}function er(e){return"function"==typeof e.getReader}function tr(e){return e[Symbol.asyncIterator]}function ir(e,t){if(e.password)if(e.username){const i=`Basic ${btoa(`${unescape(e.username)}:${unescape(e.password)}`)}`;t.append("Authorization",unescape(i)),e.username="",e.password=""}else{const i=`Bearer ${e.password}`;t.append("Authorization",unescape(i)),e.password=""}}async function ar({url:e,fetch:t=globalThis.fetch,signal:i}){const a=await t(e,{method:"HEAD",signal:i});await Qa(a);const r=a.headers.get("x-ipfs-datasize")||a.headers.get("Content-Length");return parseInt(r,10)}async function*rr({url:e,start:t,end:i,format:a,signal:r,fetch:s=globalThis.fetch}){const o=new Headers;Number.isInteger(t)&&(Number.isInteger(i)?o.set("Range",`bytes=${t}-${i}`):o.set("Range",`bytes=${t}-`));const n=new URL(e);a&&(o.set("Accept",`application/vnd.ipld.${a}`),o.set("cache-control","no-cache"));const l=await s(n.href,{headers:o,signal:r});await Qa(l),yield*Ja(l.body)}async function*sr({url:e,start:t,end:i,format:a,signal:r,gatewayURL:s=or()}){const o=function(e,t=or()){const{cid:i,path:a,type:r}=Va(e);return new URL(`/${r}/${i}${a}`,t)}(e,s);yield*rr({url:o,start:t,end:i,format:a,signal:r})}function or(){if(!globalThis.location)return Ga;const{pathname:e,hostname:t,protocol:i}=globalThis.location;if(e.startsWith("/ipfs/")||e.startsWith("/ipns/"))return`${i}//${t}/`;const[a,...r]=t.split(".");return 59===a.length&&r.length>=2?`${i}//${r.join(".")}/`:Ga}let nr=!1;const lr=[5001,45001,45002,45003,45004,45005],cr="https://api.web3.storage/",dr="https://api.estuary.tech/",hr="http://localhost:5001/",pr=1e3,ur="agregore",fr="daemon",br="daemon:preferred",mr="web3.storage",gr="estuary",vr="readonly",wr=[br,ur,fr,mr,gr,vr];class xr{get type(){return"invalid"}async*get(e,{start:t,end:i,signal:a=null,format:r=null}={}){throw new Error("Not Implemented")}async getSize(e,t=null){throw new Error("Not Implemented")}async uploadCAR(e,t=null){throw new Error("Not Implemented")}async uploadFile(e,t,i=null){throw new Error("Not Implemented")}async clear(e,t=null){throw new Error("Not Implemented")}}async function kr({daemonURL:e,web3StorageToken:t,web3StorageURL:i=cr,estuaryToken:a,estuaryURL:r=dr,publicGatewayURL:s=or(),readonly:o=!0,timeout:n=pr,fetch:l=globalThis.fetch}={}){const c=[],d=[];if(d.push(async function(e=globalThis.fetch){try{return await e("ipfs://localhost/"),!0}catch(e){return nr&&console.warn("Unable to detect Agregore",e),!1}}(l).then((e=>e&&c.push({type:ur,fetch:l})))),d.push(async function(){const e=lr.map((e=>`http://localhost:${e}`));try{const i=await Promise.any(e.map((e=>Ur(e).then((t=>{if(t)return e;throw new Error("Not found")})))));return!!i&&(Ar&&!Ir&&(t=i,Ir=!0,globalThis.chrome.webRequest.onBeforeSendHeaders.addListener((e=>{const{requestHeaders:i}=e;for(const e of i)if("origin"===e.name.toLowerCase())return e.value=t,{requestHeaders:i};return e.requestHeaders.push({name:"Origin",value:t}),{requestHeaders:i}}),{urls:[t+"/*"]},["blocking","requestHeaders","extraHeaders"])),i)}catch{return!1}var t}().then((e=>e&&c.push({type:fr,url:e,fetch:l})))),e&&d.push(Ur(e,n,l).then((t=>t&&c.push({type:br,url:e,fetch:l})))),a){const e=r,t=a;c.push({type:gr,url:e,authorization:t,fetch:l,publicGatewayURL:s})}if(t){const e=i,a=t;c.push({type:mr,url:e,authorization:a,fetch:l,publicGatewayURL:s})}return o&&s&&c.push({type:vr,fetch:l,publicGatewayURL:s}),await Promise.allSettled(d),c}async function yr({chooseOrder:e=wr,...t}={}){const i=function(e,t=wr){const i=e.filter((({type:e})=>t.includes(e))).sort((({type:e},{type:i})=>t.indexOf(e)-t.indexOf(i))),a=i[0];if(!a)throw new Error("Unable to find valid type");return a}(await kr(t),e);return async function(e){const{type:t}=e;let i=null;if(t===ur)i=new _r(e.fetch||globalThis.fetch);else if(t.startsWith(fr))i=new Cr(e.url);else if(t===mr)i=new zr(e.authorization,e.url,e.publicGatewayURL);else if(t===gr)i=new Sr(e.authorization,e.url,e.publicGatewayURL);else{if(t!==vr)throw new TypeError(`Unknown API type: ${t}.`);i=new $r(e.publicGatewayURL)}return i}(i)}class $r extends xr{constructor(e=or()){super(),this.gatewayURL=e}get type(){return vr}async*get(e,{start:t,end:i,signal:a=null,format:r=null}={}){yield*sr({url:e,start:t,end:i,format:r,gatewayURL:this.gatewayURL,signal:a})}async getSize(e,t=null){const{cid:i,path:a,type:r}=Va(e);return ar({url:new URL(`/${r}/${i}${a}`,this.gatewayURL),signal:t})}}class Sr extends $r{constructor(e,t=dr,i=or()){super(i),this.authorization=e,this.url=t}get type(){return gr}async uploadCAR(e,t=null){throw new Error("Not Implemented")}async uploadFile(e,t,i=null){const a=new URL("/content/add",this.url);a.password=this.authorization;const r=await Xa({url:a,file:e,fileName:t,parameterName:"data",signal:i}),{cid:s}=await r.json();return`ipfs://${s}/`}}class _r extends xr{constructor(e=globalThis.fetch){super(),this.fetch=e}get type(){return ur}async*get(e,{start:t,end:i,signal:a=null,format:r=null}={}){const{fetch:s}=this;yield*rr({url:e,start:t,end:i,format:r,fetch:s,signal:a})}async getSize(e,t=null){const{fetch:i}=this;return ar({url:e,fetch:i,signal:t})}async uploadCAR(e,t=null){const i=await Ka(e),{fetch:a}=this,r=await a("ipfs://localhost",{method:"POST",headers:{"Content-Type":"application/vnd.ipld.car"},signal:t,body:i});await Qa(r);return(await r.text()).split("\n")}async uploadFile(e,t=null){const i=await Ka(e),{fetch:a}=this,r=await a("ipfs://localhost",{method:"POST",headers:{"Content-Type":"application/octet-stream"},signal:t,body:i});return await Qa(r),r.headers.get("Location")}}class zr extends $r{constructor(e,t=cr,i=or()){super(i),this.authorization=e,this.url=t}get type(){return mr}async uploadCAR(e,t=null){const i=new URL("/car",this.url);i.password=this.authorization;const a=await async function({url:e,fileIterator:t,signal:i}){const a=new Headers;a.set("Content-Type","application/octet-stream"),ir(e,a);const r=await Ka(t),s=await fetch(e,{method:"POST",signal:i,body:r,headers:a,duplex:"half"});return await Qa(s),s}({url:i,fileIterator:e,signal:t});return(await a.text()).split("\n").filter((e=>e)).map((e=>{const{cid:t}=JSON.parse(e);return`ipfs://${t}/`}))}async uploadFile(e,{fileName:t="",signal:i=null}={}){const a=new URL("/upload",this.url);a.password=this.authorization;const r=await Xa({url:a,file:e,fileName:t,signal:i}),{cid:s}=await r.json();return`ipfs://${s}/`}}class Cr extends xr{constructor(e=hr){super(),this.url=e}get type(){return fr}async*getFile(e,{start:t,end:i,signal:a=null,format:r=null}={}){const{cid:s,path:o,type:n}=Va(e),l=new URL(`/api/v0/cat?arg=/${n}/${s}${o}`,this.url);if(t&&l.searchParams.set("offset",t),i&&l.searchParams.set("length",i-(t||0)+1),r)throw new Error("Format is unsupported on Kubo Daemons for now");const c=await fetch(l,{method:"POST",signal:a});await Qa(c),yield*Ja(c.body)}async*getRaw(e,{signal:t=null}={}){const{cid:i,path:a,type:r}=Va(e),s=new URL(`/api/v0/block/get?arg=/${r}/${i}${a}`,this.url),o=await fetch(s,{method:"POST",signal:t});await Qa(o),yield*Ja(o.body)}async*getCar(e,{signal:t=null}={}){const{cid:i,path:a,type:r}=Va(e),s=new URL(`/api/v0/dag/export?arg=/${r}/${i}${a}`,this.url),o=await fetch(s,{method:"POST",signal:t});await Qa(o),yield*Ja(o.body)}async*get(e,{start:t,end:i,signal:a=null,format:r=null}={}){if(r)if("raw"===r)yield*this.getRaw(e,{start:t,end:i,signal:a});else{if("car"!==r)throw new Error(`Invalid format type, must be car or 'raw', got ${r}`);yield*this.getCar(e,{start:t,end:i,signal:a})}yield*this.getFile(e,{start:t,end:i,signal:a})}async getSize(e,t=null){try{const{cid:i,path:a,type:r}=Va(e),s=`/api/v0/file/ls?arg=/${r}/${i}${a}&size=true`,o=new URL(s,this.url),n=await fetch(o,{method:"POST",signal:t});await Qa(n);const{Objects:l}=await n.json(),[{Size:c}]=Object.values(l);return c}catch(i){return nr&&console.warn(i),this._getSizeWithDag(e,t)}}async _getSizeWithDag(e,t=null){const{cid:i,path:a,type:r}=Va(e),s=new URL(`/api/v0/dag/stat?arg=/${r}/${i}${a}`,this.url),o=await fetch(s,{method:"POST",signal:t});await Qa(o);const{Size:n}=await o.json();return parseInt(n,10)}async _pin(e,t=null){const{cid:i,path:a,type:r}=Va(e),s=new URL(`/api/v0/pin/add?arg=/${r}/${i}${a}`,this.url),o=await fetch(s,{method:"POST",signal:t});await Qa(o)}async _unpin(e,t=null){const{cid:i,path:a,type:r}=Va(e),s=new URL(`/api/v0/pin/rm?arg=/${r}/${i}${a}`,this.url),o=await fetch(s,{method:"POST",signal:t});await Qa(o)}async clear(e,t=null){return this._unpin(e,t)}async uploadCAR(e,t=null){const i=new URL("/api/v0/dag/import?allow-big-block=true&pin-roots=true",this.url),a=await Xa({url:i,file:e,signal:t});return(await a.text()).split("\n").filter((e=>e)).map((e=>{const{Root:t}=JSON.parse(e);return`ipfs://${t.Cid["/"]}/`}))}async uploadFile(e,t="",i=null){const a=new URL("/api/v0/add?pin=true&cid-version=1&inline=false&raw-leaves=true",this.url),r=e.name&&e instanceof Blob;(t||r)&&a.searchParams.set("wrap-with-directory","true");const s=await Xa({url:a,file:e,fileName:t,signal:i}),o=await s.text(),[n]=o.split("\n"),{Hash:l}=JSON.parse(n),c=`ipfs://${l}/`;return await this._pin(c,i),c}}let Ir=!1;const Ar=!!(globalThis&&globalThis.chrome&&globalThis.chrome.webRequest&&globalThis.chrome.webRequest.onBeforeSendHeaders&&globalThis.chrome.webRequest.onBeforeSendHeaders.addListener);async function Ur(e=hr,t=1e3,i=globalThis.fetch){try{const a=new AbortController,{signal:r}=a;setTimeout((()=>a.abort()),t);const s=await i(new URL("/api/v0/version",e),{method:"POST",signal:r});return!!s.ok||!(!s.status||404===s.status)}catch(t){return nr&&console.warn("Unable to detect Kubo Daemon",t,e),!1}}function Pr(e,t){return self.chrome&&self.chrome.storage?new Promise((i=>{const a={};a[e]=t,self.chrome.storage.local.set(a,(()=>i()))})):self.localStorage?Promise.resolve(localStorage.setItem(e,t)):Promise.reject()}function Dr(e){return self.chrome&&self.chrome.storage?new Promise((t=>{self.chrome.storage.local.get(e,(i=>{t(i[e])}))})):self.localStorage?Promise.resolve(localStorage.getItem(e)):Promise.reject()}const Lr="0.12.7",Tr="https://w3s.link/ipfs/",Er="https://app.browsertrix.com";class Rr extends Fe{constructor(){super(),this.navMenuShown=!1,this.showCollDrop=!1,this.colls=[],this.autorun=!1,this.settingsError="",this.settingsTab=localStorage.getItem("settingsTab")||"browsertrix";try{const e=localStorage.getItem("ipfsOpts");this.ipfsOpts=JSON.parse(e)}catch(e){}this.ipfsOpts=this.ipfsOpts||{daemonUrl:"",message:"",useCustom:!1,autoDetect:!1,gatewayUrl:Tr};try{const e=localStorage.getItem("btrixOpts");this.btrixOpts=JSON.parse(e),this.doBtrixLogin()}catch(e){this.btrixOpts=null}Dr("autorunBehaviors").then((e=>this.autorun="1"===e)),window.archivewebpage&&window.archivewebpage.setDownloadCallback((e=>this.onDownloadProgress(e)))}async doBtrixLogin(){try{this.btrixOpts.client=await Wa.login(this.btrixOpts)}catch(e){this.btrixOpts=null}}get appName(){return"ArchiveWeb.page"}static get properties(){return{...Fe.properties,showStartRecord:{type:Boolean},showCollDrop:{type:Boolean},colls:{type:Array},selCollId:{type:String},selCollTitle:{type:String},recordUrl:{type:String},autorun:{type:Boolean},showNew:{type:String},showImport:{type:Boolean},isImportExisting:{type:Boolean},loadedCollId:{type:String},showDownloadProgress:{type:Boolean},download:{type:Object},ipfsOpts:{type:Object},btrixOpts:{type:Object},uploadCollOpts:{type:Object},showSettings:{type:Boolean},settingsTab:{type:String},settingsError:{type:String},showIpfsShareFailed:{type:Boolean}}}initRoute(){const e=new URLSearchParams(window.location.search);e.has("config")?(super.initRoute(),this.handleMessages()):(this.inited=!0,this.sourceUrl=e.get("source")||""),this.embed||this.checkIPFS()}async checkSW(){const e=await navigator.serviceWorker.getRegistrations();for(const t of e)t.active&&t.active.scriptURL.endsWith("/replay/sw.js")&&await t.unregister()&&self.location.reload();_e&&!e.length&&(this.swmanager=new Me({name:this.swName,appName:this.appName}),this.swmanager.register().catch((()=>this.swErrorMsg=this.swmanager.renderErrorReport(this.mainLogo))))}firstUpdated(){if(this.embed=this.pageParams.get("embed")||"",this.embed)return super.firstUpdated();this.checkSW(),this.initRoute(),window.addEventListener("popstate",(()=>{this.initRoute()}))}handleMessages(){window.addEventListener("message",(async e=>{if(this.embed&&this.loadedCollId&&"object"==typeof e.data&&"downloadToBlob"===e.data.msg_type){const t=await fetch(`${ye}/c/${this.loadedCollId}/dl?format=wacz&pages=all`),i=await t.blob();e.source.postMessage({msg_type:"downloadedBlob",coll:this.loadedCollId,url:URL.createObjectURL(i)})}}))}onStartLoad(e){this.embed||(this.showImport=!1,this.sourceUrl=e.detail.sourceUrl,this.loadInfo=e.detail,this.isImportExisting&&this.selCollId&&(this.loadInfo.importCollId=this.selCollId))}onCollLoaded(e){if(this.loadInfo&&this.loadInfo.importCollId&&navigator.serviceWorker.controller){const e={msg_type:"reload",full:!0,name:this.loadInfo.importCollId};navigator.serviceWorker.controller.postMessage(e)}this.embed&&(this.loadedCollId=e.detail.collInfo&&e.detail.collInfo.coll),super.onCollLoaded(e),!e.detail.alreadyLoaded&&e.detail.sourceUrl&&e.detail.sourceUrl!==this.sourceUrl&&(this.sourceUrl=e.detail.sourceUrl)}getLoadInfo(e){if(this.disableCSP(),this.loadInfo)return this.loadInfo;return{customColl:e.startsWith("local://")?e.slice(8):e}}async disableCSP(){if(this.embed||!self.chrome||!self.chrome.runtime)return;const e=navigator.userAgent.match(/Chrome\/([\d]+)/);if(!e||Number(e[1])<94)return;console.log("attempt to disable CSP to ensure replay works");let t=await new Promise((e=>{chrome.tabs.getCurrent((t=>e(t.id)))}));chrome.runtime.sendMessage({msg:"disableCSP",tabId:t})}static get styles(){return Se(Rr.appStyles)}static get appStyles(){return Se(o`
      :host {
        font-size: initial;
        overflow: auto;
      }
          ...
          <div class="message-body">
            <div class="buttons">
              ...
              <button class="button is-small no-pad-mobile" title="Start Archiving" ?disabled="${!this.colls}" @click="${this.onShowStart}">
                <span class="icon">
                  <fa-icon size="1.0em" aria-hidden="true" .svg="${$a()}"></fa-icon>
                </span>
                <span class="is-hidden-mobile">Start Archiving</span>
              </button>
              <div class="rightbar">
                <div class="infomsg is-hidden-mobile">The ArchiveWeb.page ${_e?"App":"Extension"} allows you to archive webpages directly in your browser!</div>
                <button class="button is-small" @click="${()=>this.showSettings=!0}">
                  <fa-icon .svg=${ka()}></fa-icon>
                </button>
              </div>
            </div>
          </div>
    ...
    ${super.render()}`}renderColl(){return M`
    <wr-rec-coll 
    .editable="${!0}"
    ...
    @show-import=${this.onShowImport}
    @do-upload=${e=>this.uploadCollOpts=e.detail}
    @about-show=${()=>this.showAbout=!0}></wr-rec-coll>`}renderCollList(e=""){return M`
    <div class="dropdown-row">
      <span>${e}&nbsp;</span>
      <div class="select is-small">
        <select @change="${this.onSelectColl}">
        ${this.colls&&this.colls.map((e=>M`
          <option value="${e.id}"
    ...
    </wr-modal>`}renderNewCollModal(){return M`
    ...
    </wr-modal`}renderImportModal(){return M`
    ...
    </wr-modal`}renderIPFSShareFailedModal(){return M`
    ...
    </wr-modal`}renderBtrixUploadModal(){return M`
      <wr-btrix-upload
      .btrixOpts=${this.btrixOpts}
      .uploadColl=${this.uploadCollOpts}
      >
      </wr-btrix-upload>`}renderDownloadModal(){return M`
    <wr-modal .noBgClose=${!0} style="--modal-width: 740px" @modal-closed="${()=>this.showDownloadProgress=!1}" title="Download Progress">
            ...
            <section class="modal-card-body">
              <div class="container">
                <div class="content">
                  <div class="is-flex">
                    <div class="has-text-centered" style="width: 220px">
                      <fa-icon class="logo" size="48px" .svg="${qa()}"></fa-icon>
      ...
      </div>`}renderSettingsModal(){return M`
    <wr-modal @modal-closed="${this.onCancelSettings}" title="Settings">
      ...
      <form class="is-flex is-flex-direction-column is-size-7" @submit="${this.onSaveSettings}">
        ...
        ${"browsertrix"===this.settingsTab?M`
        ...
        <fieldset>
          <div class="field has-addons">
            <p class="is-expanded">
              Browsertrix URL:
              <input class="input is-small" type="url"
              name="btrixUrl" id="btrixUrl" value="${this.btrixOpts&&this.btrixOpts.url||Er}"
              placeholder="${Er}">
            </p>
          </div>
          <div class="field has-addons">
    ...
    `}async onNewColl(e){this.showNew="loading",e.preventDefault();const t=this.renderRoot.querySelector("#new-title").value,i=JSON.stringify({metadata:{title:t}}),a=await fetch(`${ye}/c/create`,{method:"POST",body:i});await a.json();const r=this.renderRoot.querySelector("wr-rec-coll-index");r&&r.loadColls(),this.showNew=null}onSelectColl(e){this.selCollId=e.currentTarget.value}async setDefaultColl(){this.selCollId||(this.selCollId=await Dr("defaultCollId")),!this.selCollId&&this.colls&&this.colls.length&&(this.selCollId=this.colls[0].id),self.chrome&&self.chrome.storage&&self.chrome.storage.local&&self.localStorage&&(await Pr("index:sortKey",localStorage.getItem("index:sortKey")),await Pr("index:sortDesc",localStorage.getItem("index:sortDesc")))}_setCurrColl(e){if(!(e instanceof CustomEvent))return void this.setDefaultColl();const{detail:t}=e;this.selCollId=t.coll,this.colls&&this.colls.length||(this.colls=[{id:t.coll,title:t.title}])}async onShowStart(e){this._setCurrColl(e),this.recordUrl=e.detail.url||"https://example.com/",this.showStartRecord=!0}onShowImport(e){this._setCurrColl(e),this.showImport=!0,this.isImportExisting=!0}onCollsLoaded(e){this.colls=e.detail.colls,this.setDefaultColl()}async onStartRecord(e){e.preventDefault();const t=this.renderRoot.querySelector("#url").value,i=this.renderRoot.querySelector("#preview"),a=i&&i.checked;this.showStartRecord=!1;const r=this.autorun,s=this.selCollId;if(await Pr("defaultCollId",s),await Pr("autorunBehaviors",r?"1":"0"),self.chrome&&self.chrome.runtime)chrome.runtime.sendMessage({msg:"startNew",url:t,collId:s,autorun:r});else if(window.archivewebpage&&window.archivewebpage.record){const e=!a;window.archivewebpage.record({url:t,collId:s,startRec:e,autorun:r})}return!1}async onTitle(e){if(super.onTitle(e),this.embed&&this.loadedCollId&&e.detail.replayTitle&&e.detail.title)try{await fetch(`${ye}/c/${this.loadedCollId}/pageTitle`,{method:"POST",body:JSON.stringify(e.detail)})}catch(e){console.warn(e)}}async onSaveSettings(e){e.preventDefault();const t=this.renderRoot.querySelector("#ipfsDaemonUrl"),i=this.renderRoot.querySelector("#ipfsGatewayUrl"),a=this.renderRoot.querySelector("#ipfsAutoDetect");if(t&&i){const e=t.value,r=i.value,s=a&&a.checked;this.ipfsOpts={daemonUrl:e,useCustom:!!e,gatewayUrl:r,autoDetect:s},await this.checkIPFS(),localStorage.setItem("ipfsOpts",JSON.stringify(this.ipfsOpts))}const r=this.renderRoot.querySelector("#btrixUrl"),s=this.renderRoot.querySelector("#btrixUsername"),o=this.renderRoot.querySelector("#btrixPassword"),n=this.renderRoot.querySelector("#btrixOrgName");if(r&&s&&o){const e=r.value,t=s.value,i=o.value,a=n&&n.value||"";if(e&&t&&i){const r={url:e,username:t,password:i,orgName:a};let s;try{s=await Wa.login(r),this.settingsError=""}catch(e){return this.settingsError="Unable to log in to Browsertrix. Check your credentials.",!1}localStorage.setItem("btrixOpts",JSON.stringify(r)),this.btrixOpts={...r,client:s}}else this.btrixOpts=null,localStorage.removeItem("btrixOpts")}return localStorage.setItem("settingsTab",this.settingsTab),this.showSettings=!1,!1}async onCancelSettings(){this.settingsError=null,this.showSettings=!1}async checkIPFS(){const e=this.ipfsOpts;if(e.useCustom&&e.daemonUrl)e.message="IPFS Access -- Custom IPFS Daemon";else if(!e.daemonUrl&&e.autoDetect){const t=await yr({web3StorageToken:""});t instanceof Cr&&(e.daemonUrl=t.url),e.useCustom=!1,t instanceof zr?e.message="Sharing via remote web3.storage":e.daemonUrl?e.daemonUrl.startsWith("http://localhost:45")?e.message="Sharing via Brave IPFS node":e.daemonUrl.startsWith("http://localhost")?e.message="Sharing via local IPFS node":e.message="":e.message="IPFS Access Unknown - Sharing Not Available"}}}customElements.define("archive-web-page-app",Rr)})();var __webpack_export_target__=self;for(var i in __webpack_exports__)__webpack_export_target__[i]=__webpack_exports__[i];__webpack_exports__.__esModule&&Object.defineProperty(__webpack_export_target__,"__esModule",{value:!0})})();